...
namespace GeneXus.Programs {
   public class GxWebStd
   {
      ...
      static public void gx_combobox_ctrl( IGxContext context ,
                                           ...
                                           String sCallerPgm )
      {
         gx_combobox_ctrl1( context, cmbCObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }
      ...
      static public void gx_listbox_ctrl( IGxContext context ,
                                          ...
                                          String sCallerPgm )
      {
         gx_listbox_ctrl1( context, lstLObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }
                                           ...
                                           String sCallerPgm )
      {
         ...
         if ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) )
         {
            ...
            GxWebStd.ClassAttribute( context, sClassString);
            GxWebStd.StyleAttribute( context, sStyleString);
            context.WriteHtmlText( " onKeyPress=\"return gx.evt.checkMaxLength(this,"+sLength+",event);\" ") ;
            context.WriteHtmlTextNl( ">") ;
            context.SendWebValue( sValue) ;
      ...
      static public void gx_combobox_ctrl_wml( IGxContext context ,
                                               ...
                                               String sCallerPgm )
      {
         gx_combobox_ctrl1_wml( context, cmbCObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }
      ...
      static public void gx_listbox_ctrl_wml( IGxContext context ,
                                              ...
                                              String sCallerPgm )
      {
         gx_listbox_ctrl1_wml( context, lstLObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }
