...
using System.IO;
public class bldarbalancegeneral : GxBaseBuilder
{
   string cs_path = "." ;
   public bldarbalancegeneral( ) : base()
   {
   }
   ...
   {
      bldarbalancegeneral x = new bldarbalancegeneral() ;
      x.SetMainSourceFile( "arbalancegeneral.cs");
