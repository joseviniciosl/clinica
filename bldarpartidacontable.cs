...
using System.IO;
public class bldarpartidacontable : GxBaseBuilder
{
   string cs_path = "." ;
   public bldarpartidacontable( ) : base()
   {
   }
   ...
   {
      bldarpartidacontable x = new bldarpartidacontable() ;
      x.SetMainSourceFile( "arpartidacontable.cs");
