...
using System.IO;
public class bldarrecetamedica : GxBaseBuilder
{
   string cs_path = "." ;
   public bldarrecetamedica( ) : base()
   {
   }
   ...
   {
      bldarrecetamedica x = new bldarrecetamedica() ;
      x.SetMainSourceFile( "arrecetamedica.cs");
