/*
               File: Gx0062
        Description: Selection List Opcion
             Author: GeneXus C# Generator version 10_1_8-58720
       Generated on: 10/2/2019 15:8:27.59
...
namespace GeneXus.Programs {
   public class gx0062 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx0062( )
      {
      ...
      public gx0062( IGxContext context )
      {
      ...
      public void execute( String aP0_pGrupoCodigo ,
                           int aP1_pMenuId ,
                           out int aP2_pOpcionId )
      {
         this.AV8pGrupoCodigo = aP0_pGrupoCodigo;
         this.AV9pMenuId = aP1_pMenuId;
         this.AV10pOpcionId = 0 ;
         executePrivate();
         aP2_pOpcionId=this.AV10pOpcionId;
      }
      ...
      {
         cmbavCopcionacceso = new GXCombobox();
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               /* GeneXus formulas. */
               context.Gx_err = 0 ;
               cmbavCopcionacceso.Name = "vCOPCIONACCESO" ;
               cmbavCopcionacceso.WebTags = "" ;
               cmbavCopcionacceso.addItem("0", "No", 0);
               cmbavCopcionacceso.addItem("1", "Si", 0);
               if ( ( cmbavCopcionacceso.ItemCount > 0 ) && (0==AV7cOpcionAcceso) )
               {
                  AV7cOpcionAcceso = (short)(NumberUtil.Val( cmbavCopcionacceso.getItemValue(1), ".")) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cOpcionAcceso", StringUtil.Str( (decimal)(AV7cOpcionAcceso), 1, 0));
               }
               GXCCtl = "OPCIONACCESO_" + sGXsfl_26_idx ;
               ...
               AV7cOpcionAcceso = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cOpcionAcceso", StringUtil.Str( (decimal)(AV7cOpcionAcceso), 1, 0));
               AV8pGrupoCodigo = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pGrupoCodigo", AV8pGrupoCodigo);
               ...
               gxgrGrid1_refresh( Grid1_PageSize26, AV6cOpcionId, AV7cOpcionAcceso, AV8pGrupoCodigo, AV9pMenuId) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               AV8pGrupoCodigo = gxfirstwebparm ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pGrupoCodigo", AV8pGrupoCodigo);
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx0062.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV8pGrupoCodigo)) + "," + UrlEncode("" +AV9pMenuId) + "," + UrlEncode("" +AV10pOpcionId)+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCOPCIONACCESO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cOpcionAcceso), 1, 0, ".", "")));
         /* Send saved values. */
         GxWebStd.gx_hidden_field( context, "nRC_Grid1", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_Grid1), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPGRUPOCODIGO", StringUtil.RTrim( AV8pGrupoCodigo));
      ...
      {
         return formatLink("gx0062.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV8pGrupoCodigo)) + "," + UrlEncode("" +AV9pMenuId) + "," + UrlEncode("" +AV10pOpcionId) ;
      }
      ...
      protected void START0D2( )
      {
         ...
         Form.Meta.addItem("Description", "Selection List Opcion", 0) ;
         context.wjLoc = "" ;
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( ( context.localUtil.CToN( cgiGet( "GXH_vCOPCIONACCESO"), ".", ",") != Convert.ToDecimal( AV7cOpcionAcceso )) )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              edtOpcionId_Internalname = "OPCIONID_"+sGXsfl_26_idx ;
                              cmbOpcionAcceso_Internalname = "OPCIONACCESO_"+sGXsfl_26_idx ;
                              edtGrupoCodigo_Internalname = "GRUPOCODIGO_"+sGXsfl_26_idx ;
                              edtMenuId_Internalname = "MENUID_"+sGXsfl_26_idx ;
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       /* Set Refresh If Copcionacceso Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCOPCIONACCESO"), ".", ",") != Convert.ToDecimal( AV7cOpcionAcceso )) )
                                       {
                                          Rfr0gs = true ;
                                       }
      ...
      protected void gxgrGrid1_refresh( int Grid1_PageSize26 ,
                                        int AV6cOpcionId ,
                                        short AV7cOpcionAcceso ,
                                        String AV8pGrupoCodigo ,
                                        int AV9pMenuId )
      {
         GxWebStd.set_html_headers( context, 0, "", "");
         disableOutput();
      ...
      protected void RF0D2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            edtMenuId_Internalname = "MENUID_"+sGXsfl_26_idx ;
            /* Using cursor H000D2 */
            pr_default.execute(0, new Object[] {AV8pGrupoCodigo, AV9pMenuId, AV6cOpcionId, AV7cOpcionAcceso});
            nGXsfl_26_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A8MenuId = H000D2_A8MenuId[0] ;
               A1GrupoCodigo = H000D2_A1GrupoCodigo[0] ;
               A16OpcionAcceso = H000D2_A16OpcionAcceso[0] ;
               A11OpcionId = H000D2_A11OpcionId[0] ;
               /* Execute user event: E120D2 */
               E120D2 ();
      ...
      {
         /* Using cursor H000D3 */
         pr_default.execute(1, new Object[] {AV8pGrupoCodigo, AV9pMenuId, AV6cOpcionId, AV7cOpcionAcceso});
      ...
      protected void STRUP0D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            cmbavCopcionacceso.Name = cmbavCopcionacceso_Internalname ;
            cmbavCopcionacceso.CurrentValue = cgiGet( cmbavCopcionacceso_Internalname) ;
            AV7cOpcionAcceso = (short)(NumberUtil.Val( cgiGet( cmbavCopcionacceso_Internalname), ".")) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cOpcionAcceso", StringUtil.Str( (decimal)(AV7cOpcionAcceso), 1, 0));
            /* Read saved values. */
            nRC_Grid1 = (short)(context.localUtil.CToN( cgiGet( "nRC_Grid1"), ".", ",")) ;
            AV8pGrupoCodigo = cgiGet( "vPGRUPOCODIGO") ;
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Opcion", "", "", "", "", "", "", "", "") ;
      ...
      protected void wb_table1_2_0D2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_9_0D2( true) ;
         }
         else
         {
            wb_table2_9_0D2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_0D2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_23_0D2( true) ;
         }
         else
         {
            wb_table3_23_0D2( false) ;
         }
         return  ;
      }

      protected void wb_table3_23_0D2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_23_0D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A16OpcionAcceso), 1, 0, ".", "")));
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( cmbOpcionAcceso.Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
         ...
         if ( wbEnd == 26 )
         {
            ...
            wb_table4_34_0D2( true) ;
         }
         else
         {
            wb_table4_34_0D2( false) ;
         }
         return  ;
      }

      protected void wb_table4_34_0D2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_23_0D2e( true) ;
         }
         else
         {
            wb_table3_23_0D2e( false) ;
         }
      }

      protected void wb_table4_34_0D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(26), 3, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "ECANCEL.", TempTags, "", context.GetButtonType( ), "HLP_Gx0062.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_34_0D2e( true) ;
         }
         else
         {
            wb_table4_34_0D2e( false) ;
         }
      }

      protected void wb_table2_9_0D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockopcionid_Internalname, "Id", "", "", lblTextblockopcionid_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx0062.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cOpcionId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6cOpcionId), 9, 0)));
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCopcionid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cOpcionId), 9, 0, ".", "")), ((1!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cOpcionId), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV6cOpcionId), "ZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(14);\"", "", "", "", "", edtavCopcionid_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, true, "right", "HLP_Gx0062.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockopcionacceso_Internalname, "Acceso", "", "", lblTextblockopcionacceso_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx0062.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cOpcionAcceso", StringUtil.Str( (decimal)(AV7cOpcionAcceso), 1, 0));
            ClassString = "Attribute" ;
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavCopcionacceso, cmbavCopcionacceso_Internalname, StringUtil.Str( (decimal)(AV7cOpcionAcceso), 1, 0), 1, cmbavCopcionacceso_Jsonclick, 0, "", "int", "", 1, 1, 0, 0, 1, "chr", 0, "", StyleString, ClassString, TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(19);\"", "", true, "HLP_Gx0062.htm");
            cmbavCopcionacceso.CurrentValue = StringUtil.Str( (decimal)(AV7cOpcionAcceso), 1, 0) ;
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, cmbavCopcionacceso_Internalname, "Values", (String)(cmbavCopcionacceso.ToJavascriptSource()));
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_0D2e( true) ;
         }
         else
         {
            wb_table2_9_0D2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8pGrupoCodigo = (String)getParm(obj,0) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pGrupoCodigo", AV8pGrupoCodigo);
         AV9pMenuId = Convert.ToInt32(getParm(obj,1)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pMenuId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9pMenuId), 9, 0)));
         AV10pOpcionId = Convert.ToInt32(getParm(obj,2)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pOpcionId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pOpcionId), 9, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?158283");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0062.js", "?158283");
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            /* ComboBox */
            Grid1Row.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbOpcionAcceso,(String)cmbOpcionAcceso_Internalname,StringUtil.Str( (decimal)(A16OpcionAcceso), 1, 0),(short)1,(String)cmbOpcionAcceso_Jsonclick,(short)0,(String)"",(String)"int",(String)"Seleccionar",(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"px",(short)0,(String)"px",(String)StyleString,(String)ClassString,(String)"",(String)"",(bool)true});
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblockopcionacceso_Internalname = "TEXTBLOCKOPCIONACCESO" ;
         cmbavCopcionacceso_Internalname = "vCOPCIONACCESO" ;
      ...
      public override void initialize_properties( )
      {
         ...
         cmbavCopcionacceso_Jsonclick = "" ;
         edtavCopcionid_Jsonclick = "" ;
         subGrid1_Allowcollapsing = 0 ;
         cmbOpcionAcceso.Link = "" ;
         ...
         Form.Caption = "Selection List Opcion" ;
      ...
      public override void initialize( )
      {
         ...
         Grid1Container = new GXWebGrid( context);
         scmdbuf = "" ;
         H000D2_A8MenuId = new int[1] ;
         H000D2_A1GrupoCodigo = new String[] {""} ;
         H000D2_A16OpcionAcceso = new short[1] ;
         H000D2_A11OpcionId = new int[1] ;
         H000D3_AGRID1_nRecordCount = new int[1] ;
         sStyleString = "" ;
         ClassString = "" ;
         StyleString = "" ;
         subGrid1_Linesclass = "" ;
         ...
         lblTextblockopcionacceso_Jsonclick = "" ;
         ...
         ROClassString = "" ;
         GXt_char6 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0062__default(),
            new Object[][] {
                new Object[] {
               H000D2_A8MenuId, H000D2_A1GrupoCodigo, H000D2_A16OpcionAcceso, H000D2_A11OpcionId
               }
               , new Object[] {
      ...
      private short AV7cOpcionAcceso ;
      ...
      private String cmbavCopcionacceso_Internalname ;
      ...
      private String lblTextblockopcionacceso_Internalname ;
      private String lblTextblockopcionacceso_Jsonclick ;
      private String cmbavCopcionacceso_Jsonclick ;
      ...
      private String AV8pGrupoCodigo ;
      private String wcpOAV8pGrupoCodigo ;
      ...
      private GXCombobox cmbavCopcionacceso ;
      private GXCombobox cmbOpcionAcceso ;
      private IDataStoreProvider pr_default ;
      private int[] H000D2_A8MenuId ;
      private String[] H000D2_A1GrupoCodigo ;
      private short[] H000D2_A16OpcionAcceso ;
      private int[] H000D2_A11OpcionId ;
      private int[] H000D3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private int aP2_pOpcionId ;
      private GXWebForm Form ;
   }

   public class gx0062__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV8pGrupoCodigo",SqlDbType.VarChar,10,0} ,
          new Object[] {"@AV9pMenuId",SqlDbType.Int,9,0} ,
          new Object[] {"@AV6cOpcionId",SqlDbType.Int,9,0} ,
          new Object[] {"@AV7cOpcionAcceso",SqlDbType.SmallInt,1,0}
          } ;
          Object[] prmH000D3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000D2", "SELECT [MenuId], [GrupoCodigo], [OpcionAcceso], [OpcionId] FROM [AccesoOpcion] WITH (NOLOCK) WHERE ([GrupoCodigo] = @AV8pGrupoCodigo and [MenuId] = @AV9pMenuId and [OpcionId] >= @AV6cOpcionId) AND ([OpcionAcceso] >= @AV7cOpcionAcceso) ORDER BY [GrupoCodigo], [MenuId], [OpcionId]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D2,11,0,false,false )
             ,new CursorDef("H000D3", "SELECT COUNT(*) FROM [AccesoOpcion] WITH (NOLOCK) WHERE ([GrupoCodigo] = @AV8pGrupoCodigo and [MenuId] = @AV9pMenuId and [OpcionId] >= @AV6cOpcionId) AND ([OpcionAcceso] >= @AV7cOpcionAcceso) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D3,1,0,false,false )
          };
       }
    }
