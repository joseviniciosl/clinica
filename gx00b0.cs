/*
       ...
       Generated on: 10/2/2019 15:8:32.36
...
namespace GeneXus.Programs {
   public class gx00b0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
                           ...
                           out String aP2_pSubCategoriaCodigo )
      {
         ...
         this.AV11pCategoriaCodigo = "" ;
         this.AV12pSubCategoriaCodigo = "" ;
         executePrivate();
         aP0_pClinicaCodigo=this.AV10pClinicaCodigo;
         aP1_pCategoriaCodigo=this.AV11pCategoriaCodigo;
         aP2_pSubCategoriaCodigo=this.AV12pSubCategoriaCodigo;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               /* GeneXus formulas. */
               context.Gx_err = 0 ;
               GXCCtl = "CATEGORIACODIGO_" + sGXsfl_36_idx ;
               ...
               AV8cSubCategoriaCodigo = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cSubCategoriaCodigo", AV8cSubCategoriaCodigo);
               AV9cSubCategoriaDescripcion = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cSubCategoriaDescripcion", AV9cSubCategoriaDescripcion);
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1 ;
               ...
               gxgrGrid1_refresh( Grid1_PageSize36, AV6cClinicaCodigo, AV7cCategoriaDescripcion, AV8cSubCategoriaCodigo, AV9cSubCategoriaDescripcion) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               ...
               {
                  AV11pCategoriaCodigo = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pCategoriaCodigo", AV11pCategoriaCodigo);
                  AV12pSubCategoriaCodigo = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12pSubCategoriaCodigo", AV12pSubCategoriaCodigo);
               }
            }
         }
         context.SetTheme("Fantastic");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00b0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV10pClinicaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV11pCategoriaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV12pSubCategoriaCodigo))+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCSUBCATEGORIACODIGO", StringUtil.RTrim( AV8cSubCategoriaCodigo));
         GxWebStd.gx_hidden_field( context, "GXH_vCSUBCATEGORIADESCRIPCION", StringUtil.RTrim( AV9cSubCategoriaDescripcion));
         /* Send saved values. */
         GxWebStd.gx_hidden_field( context, "nRC_Grid1", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_Grid1), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPCLINICACODIGO", StringUtil.RTrim( AV10pClinicaCodigo));
         GxWebStd.gx_hidden_field( context, "vPCATEGORIACODIGO", StringUtil.RTrim( AV11pCategoriaCodigo));
         GxWebStd.gx_hidden_field( context, "vPSUBCATEGORIACODIGO", StringUtil.RTrim( AV12pSubCategoriaCodigo));
      ...
      {
         return formatLink("gx00b0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV10pClinicaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV11pCategoriaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV12pSubCategoriaCodigo)) ;
      }
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vCSUBCATEGORIACODIGO"), AV8cSubCategoriaCodigo) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vCSUBCATEGORIADESCRIPCION"), AV9cSubCategoriaDescripcion) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              edtCategoriaDescripcion_Internalname = "CATEGORIADESCRIPCION_"+sGXsfl_36_idx ;
                              edtSubCategoriaCodigo_Internalname = "SUBCATEGORIACODIGO_"+sGXsfl_36_idx ;
                              edtSubCategoriaDescripcion_Internalname = "SUBCATEGORIADESCRIPCION_"+sGXsfl_36_idx ;
                              dynCategoriaCodigo_Internalname = "CATEGORIACODIGO_"+sGXsfl_36_idx ;
      ...
      protected void GXDLACATEGORIACODIGO0I2( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "max-age=0");
      ...
      protected void GXACATEGORIACODIGO_html0I2( )
      {
      ...
      protected void GXDLACATEGORIACODIGO_data0I2( )
      {
         /* Using cursor H000I2 */
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.RTrim( H000I2_A27CategoriaCodigo[0]));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H000I2_A28CategoriaDescripcion[0]));
      ...
      protected void gxgrGrid1_refresh( int Grid1_PageSize36 ,
                                        ...
                                        String AV8cSubCategoriaCodigo ,
                                        String AV9cSubCategoriaDescripcion )
      {
         GxWebStd.set_html_headers( context, 0, "", "");
         disableOutput();
      ...
      protected void RF0I2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cCategoriaDescripcion", AV7cCategoriaDescripcion);
            lV8cSubCategoriaCodigo = StringUtil.PadR( StringUtil.RTrim( AV8cSubCategoriaCodigo), 10, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cSubCategoriaCodigo", AV8cSubCategoriaCodigo);
            lV9cSubCategoriaDescripcion = StringUtil.PadR( StringUtil.RTrim( AV9cSubCategoriaDescripcion), 100, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cSubCategoriaDescripcion", AV9cSubCategoriaDescripcion);
            /* Using cursor H000I3 */
            pr_default.execute(1, new Object[] {lV6cClinicaCodigo, lV7cCategoriaDescripcion, lV8cSubCategoriaCodigo, lV9cSubCategoriaDescripcion});
            nGXsfl_36_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(1) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A27CategoriaCodigo = H000I3_A27CategoriaCodigo[0] ;
               A125SubCategoriaDescripcion = H000I3_A125SubCategoriaDescripcion[0] ;
               A124SubCategoriaCodigo = H000I3_A124SubCategoriaCodigo[0] ;
               A28CategoriaDescripcion = H000I3_A28CategoriaDescripcion[0] ;
               A41ClinicaCodigo = H000I3_A41ClinicaCodigo[0] ;
               A28CategoriaDescripcion = H000I3_A28CategoriaDescripcion[0] ;
               /* Execute user event: E120I2 */
               E120I2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cSubCategoriaDescripcion", AV9cSubCategoriaDescripcion);
         /* Using cursor H000I4 */
         pr_default.execute(2, new Object[] {lV6cClinicaCodigo, lV7cCategoriaDescripcion, lV8cSubCategoriaCodigo, lV9cSubCategoriaDescripcion});
         GRID1_nRecordCount = H000I4_AGRID1_nRecordCount[0] ;
         pr_default.close(2);
      ...
      protected void STRUP0I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cCategoriaDescripcion", AV7cCategoriaDescripcion);
            AV8cSubCategoriaCodigo = cgiGet( edtavCsubcategoriacodigo_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cSubCategoriaCodigo", AV8cSubCategoriaCodigo);
            AV9cSubCategoriaDescripcion = cgiGet( edtavCsubcategoriadescripcion_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cSubCategoriaDescripcion", AV9cSubCategoriaDescripcion);
            /* Read saved values. */
            nRC_Grid1 = (short)(context.localUtil.CToN( cgiGet( "nRC_Grid1"), ".", ",")) ;
            AV10pClinicaCodigo = cgiGet( "vPCLINICACODIGO") ;
            AV11pCategoriaCodigo = cgiGet( "vPCATEGORIACODIGO") ;
            AV12pSubCategoriaCodigo = cgiGet( "vPSUBCATEGORIACODIGO") ;
      ...
      protected void E130I2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pClinicaCodigo", AV10pClinicaCodigo);
         AV11pCategoriaCodigo = A27CategoriaCodigo ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pCategoriaCodigo", AV11pCategoriaCodigo);
         AV12pSubCategoriaCodigo = A124SubCategoriaCodigo ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12pSubCategoriaCodigo", AV12pSubCategoriaCodigo);
         context.setWebReturnParms(new Object[] {(String)AV10pClinicaCodigo,(String)AV11pCategoriaCodigo,(String)AV12pSubCategoriaCodigo});
      ...
      protected void wb_table1_2_0I2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_9_0I2( true) ;
         }
         else
         {
            wb_table2_9_0I2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_0I2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_33_0I2( true) ;
         }
         else
         {
            wb_table3_33_0I2( false) ;
         }
         return  ;
      }

      protected void wb_table3_33_0I2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_33_0I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 36 )
         {
            ...
            wb_table4_45_0I2( true) ;
         }
         else
         {
            wb_table4_45_0I2( false) ;
         }
         return  ;
      }

      protected void wb_table4_45_0I2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_33_0I2e( true) ;
         }
         else
         {
            wb_table3_33_0I2e( false) ;
         }
      }

      protected void wb_table4_45_0I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "ECANCEL.", TempTags, "", context.GetButtonType( ), "HLP_Gx00B0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_45_0I2e( true) ;
         }
         else
         {
            wb_table4_45_0I2e( false) ;
         }
      }

      protected void wb_table2_9_0I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockclinicacodigo_Internalname, "Código", "", "", lblTextblockclinicacodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00B0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cClinicaCodigo", AV6cClinicaCodigo);
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCclinicacodigo_Internalname, StringUtil.RTrim( AV6cClinicaCodigo), StringUtil.RTrim( context.localUtil.Format( AV6cClinicaCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(14);\"", "", "", "", "", edtavCclinicacodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00B0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockcategoriadescripcion_Internalname, "Descripción", "", "", lblTextblockcategoriadescripcion_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00B0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cCategoriaDescripcion", AV7cCategoriaDescripcion);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCcategoriadescripcion_Internalname, StringUtil.RTrim( AV7cCategoriaDescripcion), StringUtil.RTrim( context.localUtil.Format( AV7cCategoriaDescripcion, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(19);\"", "", "", "", "", edtavCcategoriadescripcion_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00B0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblocksubcategoriacodigo_Internalname, "Sub_Categoría", "", "", lblTextblocksubcategoriacodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00B0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cSubCategoriaCodigo", AV8cSubCategoriaCodigo);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCsubcategoriacodigo_Internalname, StringUtil.RTrim( AV8cSubCategoriaCodigo), StringUtil.RTrim( context.localUtil.Format( AV8cSubCategoriaCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(24);\"", "", "", "", "", edtavCsubcategoriacodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00B0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblocksubcategoriadescripcion_Internalname, "Descripción", "", "", lblTextblocksubcategoriadescripcion_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00B0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cSubCategoriaDescripcion", AV9cSubCategoriaDescripcion);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCsubcategoriadescripcion_Internalname, StringUtil.RTrim( AV9cSubCategoriaDescripcion), StringUtil.RTrim( context.localUtil.Format( AV9cSubCategoriaDescripcion, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(29);\"", "", "", "", "", edtavCsubcategoriadescripcion_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00B0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_0I2e( true) ;
         }
         else
         {
            wb_table2_9_0I2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pClinicaCodigo", AV10pClinicaCodigo);
         AV11pCategoriaCodigo = (String)getParm(obj,1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pCategoriaCodigo", AV11pCategoriaCodigo);
         AV12pSubCategoriaCodigo = (String)getParm(obj,2) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12pSubCategoriaCodigo", AV12pSubCategoriaCodigo);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1583293");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00b0.js", "?1583293");
      ...
      protected void sendrow_362( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_36_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A41ClinicaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A27CategoriaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A124SubCategoriaCodigo))+"'"+"]);" ;
            ClassString = "Image" ;
            StyleString = "" ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            edtSubCategoriaDescripcion_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A41ClinicaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A27CategoriaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A124SubCategoriaCodigo))+"'"+"]);" ;
      ...
      public override void initialize( )
      {
         ...
         AV8cSubCategoriaCodigo = "" ;
         AV9cSubCategoriaDescripcion = "" ;
         AV10pClinicaCodigo = "" ;
         AV11pCategoriaCodigo = "" ;
         AV12pSubCategoriaCodigo = "" ;
         sDynURL = "" ;
         FormProcess = "" ;
         GX_FocusControl = "" ;
         Form = new GXWebForm();
         ...
         gxwrpcisep = "" ;
         scmdbuf = "" ;
         H000I2_A41ClinicaCodigo = new String[] {""} ;
         H000I2_A27CategoriaCodigo = new String[] {""} ;
         H000I2_A28CategoriaDescripcion = new String[] {""} ;
         H000I2_A29CategoriaEstado = new short[1] ;
         Grid1Container = new GXWebGrid( context);
         lV6cClinicaCodigo = "" ;
         lV7cCategoriaDescripcion = "" ;
         lV8cSubCategoriaCodigo = "" ;
         lV9cSubCategoriaDescripcion = "" ;
         H000I3_A27CategoriaCodigo = new String[] {""} ;
         H000I3_A125SubCategoriaDescripcion = new String[] {""} ;
         H000I3_A124SubCategoriaCodigo = new String[] {""} ;
         H000I3_A28CategoriaDescripcion = new String[] {""} ;
         H000I3_A41ClinicaCodigo = new String[] {""} ;
         H000I4_AGRID1_nRecordCount = new int[1] ;
         sStyleString = "" ;
         ClassString = "" ;
         StyleString = "" ;
         subGrid1_Linesclass = "" ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00b0__default(),
            new Object[][] {
                new Object[] {
               H000I2_A41ClinicaCodigo, H000I2_A27CategoriaCodigo, H000I2_A28CategoriaDescripcion, H000I2_A29CategoriaEstado
               }
               , new Object[] {
               H000I3_A27CategoriaCodigo, H000I3_A125SubCategoriaDescripcion, H000I3_A124SubCategoriaCodigo, H000I3_A28CategoriaDescripcion, H000I3_A41ClinicaCodigo
               }
               , new Object[] {
               H000I4_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private String AV8cSubCategoriaCodigo ;
      private String AV9cSubCategoriaDescripcion ;
      private String AV10pClinicaCodigo ;
      private String AV11pCategoriaCodigo ;
      private String AV12pSubCategoriaCodigo ;
      ...
      private String lV8cSubCategoriaCodigo ;
      private String lV9cSubCategoriaDescripcion ;
      ...
      private String[] H000I2_A41ClinicaCodigo ;
      private String[] H000I2_A27CategoriaCodigo ;
      private String[] H000I2_A28CategoriaDescripcion ;
      private short[] H000I2_A29CategoriaEstado ;
      private String[] H000I3_A27CategoriaCodigo ;
      private String[] H000I3_A125SubCategoriaDescripcion ;
      private String[] H000I3_A124SubCategoriaCodigo ;
      private String[] H000I3_A28CategoriaDescripcion ;
      private String[] H000I3_A41ClinicaCodigo ;
      private int[] H000I4_AGRID1_nRecordCount ;
   ...
   public class gx00b0__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV8cSubCategoriaCodigo",SqlDbType.VarChar,10,0} ,
          new Object[] {"@lV9cSubCategoriaDescripcion",SqlDbType.VarChar,100,0}
          } ;
          Object[] prmH000I4 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000I2", "SELECT [ClinicaCodigo], [CategoriaCodigo], [CategoriaDescripcion], [CategoriaEstado] FROM [Categoria] WITH (NOLOCK) WHERE [CategoriaEstado] = 1 ORDER BY [CategoriaDescripcion] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I2,0,0,true,false )
             ,new CursorDef("H000I3", "SELECT T1.[CategoriaCodigo], T1.[SubCategoriaDescripcion], T1.[SubCategoriaCodigo], T2.[CategoriaDescripcion], T1.[ClinicaCodigo] FROM ([SubCategoria] T1 WITH (NOLOCK) INNER JOIN [Categoria] T2 WITH (NOLOCK) ON T2.[ClinicaCodigo] = T1.[ClinicaCodigo] AND T2.[CategoriaCodigo] = T1.[CategoriaCodigo]) WHERE (T1.[ClinicaCodigo] like @lV6cClinicaCodigo) AND (T2.[CategoriaDescripcion] like @lV7cCategoriaDescripcion) AND (T1.[SubCategoriaCodigo] like @lV8cSubCategoriaCodigo) AND (T1.[SubCategoriaDescripcion] like @lV9cSubCategoriaDescripcion) ORDER BY T1.[ClinicaCodigo], T1.[CategoriaCodigo], T1.[SubCategoriaCodigo]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I3,11,0,true,false )
             ,new CursorDef("H000I4", "SELECT COUNT(*) FROM ([SubCategoria] T1 WITH (NOLOCK) INNER JOIN [Categoria] T2 WITH (NOLOCK) ON T2.[ClinicaCodigo] = T1.[ClinicaCodigo] AND T2.[CategoriaCodigo] = T1.[CategoriaCodigo]) WHERE (T1.[ClinicaCodigo] like @lV6cClinicaCodigo) AND (T2.[CategoriaDescripcion] like @lV7cCategoriaDescripcion) AND (T1.[SubCategoriaCodigo] like @lV8cSubCategoriaCodigo) AND (T1.[SubCategoriaDescripcion] like @lV9cSubCategoriaDescripcion) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I4,1,0,true,false )
          };
       }
    }
