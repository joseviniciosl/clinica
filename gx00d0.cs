/*
               File: Gx00D0
        Description: Selection List Países
             Author: GeneXus C# Generator version 10_1_8-58720
       Generated on: 10/2/2019 15:8:35.20
...
namespace GeneXus.Programs {
   public class gx00d0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( out String aP0_pPaisCodigo )
      {
         this.AV8pPaisCodigo = "" ;
         executePrivate();
         aP0_pPaisCodigo=this.AV8pPaisCodigo;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7cPaisNombre = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cPaisNombre", AV7cPaisNombre);
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1 ;
               ...
               gxgrGrid1_refresh( Grid1_PageSize26, AV6cPaisCodigo, AV7cPaisNombre) ;
               return  ;
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00d0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV8pPaisCodigo))+"\" class=\""+"Form"+"\">") ;
      ...
      {
         return formatLink("gx00d0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV8pPaisCodigo)) ;
      }
      ...
      protected void START0K2( )
      {
         ...
         Form.Meta.addItem("Description", "Selection List Países", 0) ;
         context.wjLoc = "" ;
      ...
      protected void RF0K2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cPaisCodigo", AV6cPaisCodigo);
            lV7cPaisNombre = StringUtil.PadR( StringUtil.RTrim( AV7cPaisNombre), 70, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cPaisNombre", AV7cPaisNombre);
            /* Using cursor H000K2 */
            pr_default.execute(0, new Object[] {lV6cPaisCodigo, lV7cPaisNombre});
            nGXsfl_26_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A36PaisNombre = H000K2_A36PaisNombre[0] ;
               A35PaisCodigo = H000K2_A35PaisCodigo[0] ;
               /* Execute user event: E120K2 */
               E120K2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cPaisNombre", AV7cPaisNombre);
         /* Using cursor H000K3 */
         pr_default.execute(1, new Object[] {lV6cPaisCodigo, lV7cPaisNombre});
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Países", "", "", "", "", "", "", "", "") ;
      ...
      {
         /* Enter Routine */
         AV8pPaisCodigo = A35PaisCodigo ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pPaisCodigo", AV8pPaisCodigo);
         context.setWebReturnParms(new Object[] {(String)AV8pPaisCodigo});
      ...
      protected void wb_table2_9_0K2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_23_0K2( true) ;
         }
         else
         {
            wb_table3_23_0K2( false) ;
         }
         return  ;
      }

      protected void wb_table3_23_0K2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_23_0K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A36PaisNombre));
         ...
         if ( wbEnd == 26 )
         {
            ...
            wb_table4_32_0K2( true) ;
         }
         else
         {
            wb_table4_32_0K2( false) ;
         }
         return  ;
      }

      protected void wb_table4_32_0K2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_23_0K2e( true) ;
         }
         else
         {
            wb_table3_23_0K2e( false) ;
         }
      }

      protected void wb_table4_32_0K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(26), 3, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "ECANCEL.", TempTags, "", context.GetButtonType( ), "HLP_Gx00D0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_32_0K2e( true) ;
         }
         else
         {
            wb_table4_32_0K2e( false) ;
         }
      }
      ...
      protected void wb_table2_9_0K2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockpaiscodigo_Internalname, "País", "", "", lblTextblockpaiscodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00D0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cPaisCodigo", AV6cPaisCodigo);
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCpaiscodigo_Internalname, StringUtil.RTrim( AV6cPaisCodigo), StringUtil.RTrim( context.localUtil.Format( AV6cPaisCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(14);\"", "", "", "", "", edtavCpaiscodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00D0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockpaisnombre_Internalname, "Nombre", "", "", lblTextblockpaisnombre_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00D0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cPaisNombre", AV7cPaisNombre);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCpaisnombre_Internalname, StringUtil.RTrim( AV7cPaisNombre), StringUtil.RTrim( context.localUtil.Format( AV7cPaisNombre, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(19);\"", "", "", "", "", edtavCpaisnombre_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 70, "chr", 1, "row", 70, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00D0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1583556");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00d0.js", "?1583556");
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A35PaisCodigo))+"'"+"]);" ;
            ClassString = "Image" ;
            StyleString = "" ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            edtPaisNombre_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A35PaisCodigo))+"'"+"]);" ;
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtPaisNombre_Internalname,StringUtil.RTrim( A36PaisNombre),(String)"",(String)"",(String)"",(String)edtPaisNombre_Link,(String)"",(String)"Seleccionar",(String)edtPaisNombre_Jsonclick,(short)0,(String)ClassString,(String)StyleString,(String)ROClassString,(short)-1,(short)0,(short)0,(short)0,(String)"px",(short)17,(String)"px",(short)70,(short)0,(short)0,(short)26,(short)1,(short)1,(bool)true,(String)"left"});
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Países" ;
      ...
      public override void initialize( )
      {
         ...
         lV6cPaisCodigo = "" ;
         lV7cPaisNombre = "" ;
         H000K2_A36PaisNombre = new String[] {""} ;
         H000K2_A35PaisCodigo = new String[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00d0__default(),
            new Object[][] {
                new Object[] {
               H000K2_A36PaisNombre, H000K2_A35PaisCodigo
               }
               , new Object[] {
      ...
      private String[] H000K2_A36PaisNombre ;
      private String[] H000K2_A35PaisCodigo ;
   ...
   public class gx00d0__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV7cPaisNombre",SqlDbType.VarChar,70,0}
          } ;
          Object[] prmH000K3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000K2", "SELECT [PaisNombre], [PaisCodigo] FROM [Pais] WITH (NOLOCK) WHERE ([PaisCodigo] like @lV6cPaisCodigo) AND ([PaisNombre] like @lV7cPaisNombre) ORDER BY [PaisCodigo]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K2,11,0,false,false )
             ,new CursorDef("H000K3", "SELECT COUNT(*) FROM [Pais] WITH (NOLOCK) WHERE ([PaisCodigo] like @lV6cPaisCodigo) AND ([PaisNombre] like @lV7cPaisNombre) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K3,1,0,false,false )
          };
       }
    }
