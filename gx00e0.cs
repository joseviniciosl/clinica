/*
       ...
       Generated on: 10/2/2019 15:8:36.3
...
namespace GeneXus.Programs {
   public class gx00e0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
                           ...
                           out String aP1_pDepCodigo )
      {
         ...
         this.AV10pDepCodigo = "" ;
         executePrivate();
         aP0_pPaisCodigo=this.AV9pPaisCodigo;
         aP1_pDepCodigo=this.AV10pDepCodigo;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV8cDepNombre = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDepNombre", AV8cDepNombre);
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1 ;
               ...
               gxgrGrid1_refresh( Grid1_PageSize31, AV6cPaisCodigo, AV7cDepCodigo, AV8cDepNombre) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               AV9pPaisCodigo = gxfirstwebparm ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pPaisCodigo", AV9pPaisCodigo);
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV10pDepCodigo = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pDepCodigo", AV10pDepCodigo);
               }
            }
         }
         context.SetTheme("Fantastic");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00e0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV9pPaisCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV10pDepCodigo))+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCDEPNOMBRE", StringUtil.RTrim( AV8cDepNombre));
         /* Send saved values. */
         GxWebStd.gx_hidden_field( context, "nRC_Grid1", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_Grid1), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPPAISCODIGO", StringUtil.RTrim( AV9pPaisCodigo));
         GxWebStd.gx_hidden_field( context, "vPDEPCODIGO", StringUtil.RTrim( AV10pDepCodigo));
      ...
      {
         return formatLink("gx00e0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV9pPaisCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV10pDepCodigo)) ;
      }
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vCDEPNOMBRE"), AV8cDepNombre) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              edtPaisCodigo_Internalname = "PAISCODIGO_"+sGXsfl_31_idx ;
                              edtDepCodigo_Internalname = "DEPCODIGO_"+sGXsfl_31_idx ;
                              edtDepNombre_Internalname = "DEPNOMBRE_"+sGXsfl_31_idx ;
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       /* Set Refresh If Cdepnombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCDEPNOMBRE"), AV8cDepNombre) != 0 )
                                       {
                                          Rfr0gs = true ;
                                       }
      ...
      protected void RF0L2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cDepCodigo", AV7cDepCodigo);
            lV8cDepNombre = StringUtil.PadR( StringUtil.RTrim( AV8cDepNombre), 70, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDepNombre", AV8cDepNombre);
            /* Using cursor H000L2 */
            pr_default.execute(0, new Object[] {lV6cPaisCodigo, lV7cDepCodigo, lV8cDepNombre});
            nGXsfl_31_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A38DepNombre = H000L2_A38DepNombre[0] ;
               A37DepCodigo = H000L2_A37DepCodigo[0] ;
               A35PaisCodigo = H000L2_A35PaisCodigo[0] ;
               /* Execute user event: E120L2 */
               E120L2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDepNombre", AV8cDepNombre);
         /* Using cursor H000L3 */
         pr_default.execute(1, new Object[] {lV6cPaisCodigo, lV7cDepCodigo, lV8cDepNombre});
      ...
      protected void STRUP0L0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cDepCodigo", AV7cDepCodigo);
            AV8cDepNombre = cgiGet( edtavCdepnombre_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDepNombre", AV8cDepNombre);
            /* Read saved values. */
            nRC_Grid1 = (short)(context.localUtil.CToN( cgiGet( "nRC_Grid1"), ".", ",")) ;
            AV9pPaisCodigo = cgiGet( "vPPAISCODIGO") ;
            AV10pDepCodigo = cgiGet( "vPDEPCODIGO") ;
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Departamentos", "", "", "", "", "", "", "", "") ;
      ...
      {
         /* Enter Routine */
         AV9pPaisCodigo = A35PaisCodigo ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pPaisCodigo", AV9pPaisCodigo);
         AV10pDepCodigo = A37DepCodigo ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pDepCodigo", AV10pDepCodigo);
         context.setWebReturnParms(new Object[] {(String)AV9pPaisCodigo,(String)AV10pDepCodigo});
      ...
      protected void wb_table2_9_0L2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_28_0L2( true) ;
         }
         else
         {
            wb_table3_28_0L2( false) ;
         }
         return  ;
      }

      protected void wb_table3_28_0L2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_28_0L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A38DepNombre));
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtDepNombre_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
         ...
         if ( wbEnd == 31 )
         {
            ...
            wb_table4_38_0L2( true) ;
         }
         else
         {
            wb_table4_38_0L2( false) ;
         }
         return  ;
      }

      protected void wb_table4_38_0L2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_28_0L2e( true) ;
         }
         else
         {
            wb_table3_28_0L2e( false) ;
         }
      }

      protected void wb_table4_38_0L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(31), 3, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "ECANCEL.", TempTags, "", context.GetButtonType( ), "HLP_Gx00E0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_38_0L2e( true) ;
         }
         else
         {
            wb_table4_38_0L2e( false) ;
         }
      }
      ...
      protected void wb_table2_9_0L2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockpaiscodigo_Internalname, "País", "", "", lblTextblockpaiscodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00E0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cPaisCodigo", AV6cPaisCodigo);
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCpaiscodigo_Internalname, StringUtil.RTrim( AV6cPaisCodigo), StringUtil.RTrim( context.localUtil.Format( AV6cPaisCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(14);\"", "", "", "", "", edtavCpaiscodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00E0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdepcodigo_Internalname, "Departamento", "", "", lblTextblockdepcodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00E0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cDepCodigo", AV7cDepCodigo);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCdepcodigo_Internalname, StringUtil.RTrim( AV7cDepCodigo), StringUtil.RTrim( context.localUtil.Format( AV7cDepCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(19);\"", "", "", "", "", edtavCdepcodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00E0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdepnombre_Internalname, "Nombre", "", "", lblTextblockdepnombre_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00E0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDepNombre", AV8cDepNombre);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCdepnombre_Internalname, StringUtil.RTrim( AV8cDepNombre), StringUtil.RTrim( context.localUtil.Format( AV8cDepNombre, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(24);\"", "", "", "", "", edtavCdepnombre_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 70, "chr", 1, "row", 70, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00E0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9pPaisCodigo = (String)getParm(obj,0) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pPaisCodigo", AV9pPaisCodigo);
         AV10pDepCodigo = (String)getParm(obj,1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pDepCodigo", AV10pDepCodigo);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1583644");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00e0.js", "?1583644");
      ...
      protected void sendrow_312( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_31_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A35PaisCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A37DepCodigo))+"'"+"]);" ;
            ClassString = "Image" ;
            StyleString = "" ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            edtDepNombre_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A35PaisCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A37DepCodigo))+"'"+"]);" ;
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtDepNombre_Internalname,StringUtil.RTrim( A38DepNombre),(String)"",(String)"",(String)"",(String)edtDepNombre_Link,(String)"",(String)"Seleccionar",(String)edtDepNombre_Jsonclick,(short)0,(String)ClassString,(String)StyleString,(String)ROClassString,(short)-1,(short)0,(short)0,(short)0,(String)"px",(short)17,(String)"px",(short)70,(short)0,(short)0,(short)31,(short)1,(short)1,(bool)true,(String)"left"});
      ...
      protected void init_default_properties( )
      {
         ...
         edtavCdepnombre_Internalname = "vCDEPNOMBRE" ;
      ...
      public override void initialize( )
      {
         ...
         lV7cDepCodigo = "" ;
         lV8cDepNombre = "" ;
         H000L2_A38DepNombre = new String[] {""} ;
         H000L2_A37DepCodigo = new String[] {""} ;
         H000L2_A35PaisCodigo = new String[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00e0__default(),
            new Object[][] {
                new Object[] {
               H000L2_A38DepNombre, H000L2_A37DepCodigo, H000L2_A35PaisCodigo
               }
               , new Object[] {
      ...
      private String edtavCdepnombre_Internalname ;
      ...
      private String edtDepNombre_Link ;
      ...
      private String edtavCdepnombre_Jsonclick ;
      ...
      private String AV8cDepNombre ;
      private String AV9pPaisCodigo ;
      private String AV10pDepCodigo ;
      ...
      private String[] H000L2_A38DepNombre ;
      private String[] H000L2_A37DepCodigo ;
      private String[] H000L2_A35PaisCodigo ;
   ...
   public class gx00e0__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV8cDepNombre",SqlDbType.VarChar,70,0}
          } ;
          Object[] prmH000L3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000L2", "SELECT [DepNombre], [DepCodigo], [PaisCodigo] FROM [Departamento] WITH (NOLOCK) WHERE ([PaisCodigo] like @lV6cPaisCodigo) AND ([DepCodigo] like @lV7cDepCodigo) AND ([DepNombre] like @lV8cDepNombre) ORDER BY [PaisCodigo], [DepCodigo]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L2,11,0,false,false )
             ,new CursorDef("H000L3", "SELECT COUNT(*) FROM [Departamento] WITH (NOLOCK) WHERE ([PaisCodigo] like @lV6cPaisCodigo) AND ([DepCodigo] like @lV7cDepCodigo) AND ([DepNombre] like @lV8cDepNombre) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L3,1,0,false,false )
          };
       }
    }
