/*
               File: Gx00H0
        Description: Selection List Clasificación CIE-10
             Author: GeneXus C# Generator version 10_1_8-58720
       Generated on: 10/2/2019 15:8:20.85
...
namespace GeneXus.Programs {
   public class gx00h0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( out String aP0_pClinicaCodigo ,
                           out String aP1_pCie10Codigo )
      {
         this.AV8pClinicaCodigo = "" ;
         this.AV9pCie10Codigo = "" ;
         executePrivate();
         aP0_pClinicaCodigo=this.AV8pClinicaCodigo;
         aP1_pCie10Codigo=this.AV9pCie10Codigo;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7cCie10Codigo = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cCie10Codigo", AV7cCie10Codigo);
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1 ;
               ...
               gxgrGrid1_refresh( Grid1_PageSize26, AV6cClinicaCodigo, AV7cCie10Codigo) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               ...
               {
                  AV9pCie10Codigo = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pCie10Codigo", AV9pCie10Codigo);
               }
            }
         }
         context.SetTheme("Fantastic");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00h0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV8pClinicaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV9pCie10Codigo))+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCCIE10CODIGO", StringUtil.RTrim( AV7cCie10Codigo));
         /* Send saved values. */
         GxWebStd.gx_hidden_field( context, "nRC_Grid1", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_Grid1), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPCLINICACODIGO", StringUtil.RTrim( AV8pClinicaCodigo));
         GxWebStd.gx_hidden_field( context, "vPCIE10CODIGO", StringUtil.RTrim( AV9pCie10Codigo));
      ...
      {
         return "Selection List Clasificación CIE-10" ;
      }
      ...
      {
         return formatLink("gx00h0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV8pClinicaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV9pCie10Codigo)) ;
      }
      ...
      protected void START072( )
      {
         ...
         Form.Meta.addItem("Description", "Selection List Clasificación CIE-10", 0) ;
         context.wjLoc = "" ;
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vCCIE10CODIGO"), AV7cCie10Codigo) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              edtCie10Codigo_Internalname = "CIE10CODIGO_"+sGXsfl_26_idx ;
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       /* Set Refresh If Ccie10codigo Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCCIE10CODIGO"), AV7cCie10Codigo) != 0 )
                                       {
                                          Rfr0gs = true ;
                                       }
      ...
      protected void RF072( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cClinicaCodigo", AV6cClinicaCodigo);
            lV7cCie10Codigo = StringUtil.PadR( StringUtil.RTrim( AV7cCie10Codigo), 10, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cCie10Codigo", AV7cCie10Codigo);
            /* Using cursor H00072 */
            pr_default.execute(0, new Object[] {lV6cClinicaCodigo, lV7cCie10Codigo});
            nGXsfl_26_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A50Cie10Codigo = H00072_A50Cie10Codigo[0] ;
               A41ClinicaCodigo = H00072_A41ClinicaCodigo[0] ;
               /* Execute user event: E12072 */
               E12072 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cCie10Codigo", AV7cCie10Codigo);
         /* Using cursor H00073 */
         pr_default.execute(1, new Object[] {lV6cClinicaCodigo, lV7cCie10Codigo});
      ...
      protected void STRUP070( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cClinicaCodigo", AV6cClinicaCodigo);
            AV7cCie10Codigo = cgiGet( edtavCcie10codigo_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cCie10Codigo", AV7cCie10Codigo);
            /* Read saved values. */
            nRC_Grid1 = (short)(context.localUtil.CToN( cgiGet( "nRC_Grid1"), ".", ",")) ;
            AV8pClinicaCodigo = cgiGet( "vPCLINICACODIGO") ;
            AV9pCie10Codigo = cgiGet( "vPCIE10CODIGO") ;
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Clasificación CIE-10", "", "", "", "", "", "", "", "") ;
      ...
      {
         /* Enter Routine */
         AV8pClinicaCodigo = A41ClinicaCodigo ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pClinicaCodigo", AV8pClinicaCodigo);
         AV9pCie10Codigo = A50Cie10Codigo ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pCie10Codigo", AV9pCie10Codigo);
         context.setWebReturnParms(new Object[] {(String)AV8pClinicaCodigo,(String)AV9pCie10Codigo});
      ...
      protected void wb_table3_23_072e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_23_072( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table4_32_072e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table4_32_072( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(26), 3, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "ECANCEL.", TempTags, "", context.GetButtonType( ), "HLP_Gx00H0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void wb_table2_9_072( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockclinicacodigo_Internalname, "Código", "", "", lblTextblockclinicacodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00H0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cClinicaCodigo", AV6cClinicaCodigo);
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCclinicacodigo_Internalname, StringUtil.RTrim( AV6cClinicaCodigo), StringUtil.RTrim( context.localUtil.Format( AV6cClinicaCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(14);\"", "", "", "", "", edtavCclinicacodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00H0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockcie10codigo_Internalname, "Código", "", "", lblTextblockcie10codigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00H0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cCie10Codigo", AV7cCie10Codigo);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCcie10codigo_Internalname, StringUtil.RTrim( AV7cCie10Codigo), StringUtil.RTrim( context.localUtil.Format( AV7cCie10Codigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(19);\"", "", "", "", "", edtavCcie10codigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00H0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pClinicaCodigo", AV8pClinicaCodigo);
         AV9pCie10Codigo = (String)getParm(obj,1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pCie10Codigo", AV9pCie10Codigo);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1582119");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00h0.js", "?1582119");
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A41ClinicaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A50Cie10Codigo))+"'"+"]);" ;
            ClassString = "Image" ;
            StyleString = "" ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavCcie10codigo_Internalname = "vCCIE10CODIGO" ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Clasificación CIE-10" ;
      ...
      public override void initialize( )
      {
         ...
         lV6cClinicaCodigo = "" ;
         lV7cCie10Codigo = "" ;
         H00072_A50Cie10Codigo = new String[] {""} ;
         H00072_A41ClinicaCodigo = new String[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00h0__default(),
            new Object[][] {
                new Object[] {
               H00072_A50Cie10Codigo, H00072_A41ClinicaCodigo
               }
               , new Object[] {
      ...
      private String edtavCcie10codigo_Internalname ;
      ...
      private String edtavCcie10codigo_Jsonclick ;
      ...
      private String[] H00072_A50Cie10Codigo ;
      private String[] H00072_A41ClinicaCodigo ;
      private int[] H00073_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private String aP0_pClinicaCodigo ;
      private String aP1_pCie10Codigo ;
   ...
   public class gx00h0__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV7cCie10Codigo",SqlDbType.VarChar,10,0}
          } ;
          Object[] prmH00073 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00072", "SELECT [Cie10Codigo], [ClinicaCodigo] FROM [Cie10] WITH (NOLOCK) WHERE ([ClinicaCodigo] like @lV6cClinicaCodigo) AND ([Cie10Codigo] like @lV7cCie10Codigo) ORDER BY [ClinicaCodigo], [Cie10Codigo]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00072,11,0,false,false )
             ,new CursorDef("H00073", "SELECT COUNT(*) FROM [Cie10] WITH (NOLOCK) WHERE ([ClinicaCodigo] like @lV6cClinicaCodigo) AND ([Cie10Codigo] like @lV7cCie10Codigo) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00073,1,0,false,false )
          };
       }
    }
