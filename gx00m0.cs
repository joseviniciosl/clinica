/*
       ...
       Generated on: 10/2/2019 15:8:42.15
...
namespace GeneXus.Programs {
   public class gx00m0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
                           ...
                           out String aP1_pFormaPagoCodigo )
      {
         ...
         this.AV10pFormaPagoCodigo = "" ;
         executePrivate();
         aP0_pClinicaCodigo=this.AV9pClinicaCodigo;
         aP1_pFormaPagoCodigo=this.AV10pFormaPagoCodigo;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7cFormaPagoCodigo = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cFormaPagoCodigo", AV7cFormaPagoCodigo);
               AV8cFormaPagoNombre = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cFormaPagoNombre", AV8cFormaPagoNombre);
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1 ;
               ...
               gxgrGrid1_refresh( Grid1_PageSize31, AV6cClinicaCodigo, AV7cFormaPagoCodigo, AV8cFormaPagoNombre) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               ...
               {
                  AV10pFormaPagoCodigo = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pFormaPagoCodigo", AV10pFormaPagoCodigo);
               }
            }
         }
         context.SetTheme("Fantastic");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00m0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV9pClinicaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV10pFormaPagoCodigo))+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCFORMAPAGOCODIGO", StringUtil.RTrim( AV7cFormaPagoCodigo));
         GxWebStd.gx_hidden_field( context, "GXH_vCFORMAPAGONOMBRE", StringUtil.RTrim( AV8cFormaPagoNombre));
         /* Send saved values. */
         GxWebStd.gx_hidden_field( context, "nRC_Grid1", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_Grid1), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPCLINICACODIGO", StringUtil.RTrim( AV9pClinicaCodigo));
         GxWebStd.gx_hidden_field( context, "vPFORMAPAGOCODIGO", StringUtil.RTrim( AV10pFormaPagoCodigo));
      ...
      {
         return formatLink("gx00m0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV9pClinicaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV10pFormaPagoCodigo)) ;
      }
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vCFORMAPAGOCODIGO"), AV7cFormaPagoCodigo) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vCFORMAPAGONOMBRE"), AV8cFormaPagoNombre) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              edtFormaPagoCodigo_Internalname = "FORMAPAGOCODIGO_"+sGXsfl_31_idx ;
                              edtFormaPagoNombre_Internalname = "FORMAPAGONOMBRE_"+sGXsfl_31_idx ;
      ...
      protected void gxgrGrid1_refresh( int Grid1_PageSize31 ,
                                        ...
                                        String AV7cFormaPagoCodigo ,
                                        String AV8cFormaPagoNombre )
      {
         GxWebStd.set_html_headers( context, 0, "", "");
         disableOutput();
      ...
      protected void RF0S2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cClinicaCodigo", AV6cClinicaCodigo);
            lV7cFormaPagoCodigo = StringUtil.PadR( StringUtil.RTrim( AV7cFormaPagoCodigo), 10, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cFormaPagoCodigo", AV7cFormaPagoCodigo);
            lV8cFormaPagoNombre = StringUtil.PadR( StringUtil.RTrim( AV8cFormaPagoNombre), 70, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cFormaPagoNombre", AV8cFormaPagoNombre);
            /* Using cursor H000S2 */
            pr_default.execute(0, new Object[] {lV6cClinicaCodigo, lV7cFormaPagoCodigo, lV8cFormaPagoNombre});
            nGXsfl_31_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A66FormaPagoNombre = H000S2_A66FormaPagoNombre[0] ;
               A65FormaPagoCodigo = H000S2_A65FormaPagoCodigo[0] ;
               A41ClinicaCodigo = H000S2_A41ClinicaCodigo[0] ;
               /* Execute user event: E120S2 */
               E120S2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cFormaPagoNombre", AV8cFormaPagoNombre);
         /* Using cursor H000S3 */
         pr_default.execute(1, new Object[] {lV6cClinicaCodigo, lV7cFormaPagoCodigo, lV8cFormaPagoNombre});
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cClinicaCodigo", AV6cClinicaCodigo);
            AV7cFormaPagoCodigo = cgiGet( edtavCformapagocodigo_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cFormaPagoCodigo", AV7cFormaPagoCodigo);
            AV8cFormaPagoNombre = cgiGet( edtavCformapagonombre_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cFormaPagoNombre", AV8cFormaPagoNombre);
            /* Read saved values. */
            nRC_Grid1 = (short)(context.localUtil.CToN( cgiGet( "nRC_Grid1"), ".", ",")) ;
            AV9pClinicaCodigo = cgiGet( "vPCLINICACODIGO") ;
            AV10pFormaPagoCodigo = cgiGet( "vPFORMAPAGOCODIGO") ;
      ...
      protected void E130S2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pClinicaCodigo", AV9pClinicaCodigo);
         AV10pFormaPagoCodigo = A65FormaPagoCodigo ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pFormaPagoCodigo", AV10pFormaPagoCodigo);
         context.setWebReturnParms(new Object[] {(String)AV9pClinicaCodigo,(String)AV10pFormaPagoCodigo});
      ...
      protected void wb_table2_9_0S2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_28_0S2( true) ;
         }
         else
         {
            wb_table3_28_0S2( false) ;
         }
         return  ;
      }

      protected void wb_table3_28_0S2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_28_0S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table4_38_0S2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_28_0S2e( true) ;
         }
         else
         {
            wb_table3_28_0S2e( false) ;
         }
      }
      ...
      protected void wb_table4_38_0S2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(31), 3, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "ECANCEL.", TempTags, "", context.GetButtonType( ), "HLP_Gx00M0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void wb_table2_9_0S2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockclinicacodigo_Internalname, "Código", "", "", lblTextblockclinicacodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00M0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cClinicaCodigo", AV6cClinicaCodigo);
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCclinicacodigo_Internalname, StringUtil.RTrim( AV6cClinicaCodigo), StringUtil.RTrim( context.localUtil.Format( AV6cClinicaCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(14);\"", "", "", "", "", edtavCclinicacodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00M0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockformapagocodigo_Internalname, "Código", "", "", lblTextblockformapagocodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00M0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cFormaPagoCodigo", AV7cFormaPagoCodigo);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCformapagocodigo_Internalname, StringUtil.RTrim( AV7cFormaPagoCodigo), StringUtil.RTrim( context.localUtil.Format( AV7cFormaPagoCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(19);\"", "", "", "", "", edtavCformapagocodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00M0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockformapagonombre_Internalname, "Forma_Pago", "", "", lblTextblockformapagonombre_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00M0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cFormaPagoNombre", AV8cFormaPagoNombre);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCformapagonombre_Internalname, StringUtil.RTrim( AV8cFormaPagoNombre), StringUtil.RTrim( context.localUtil.Format( AV8cFormaPagoNombre, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(24);\"", "", "", "", "", edtavCformapagonombre_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 70, "chr", 1, "row", 70, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00M0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pClinicaCodigo", AV9pClinicaCodigo);
         AV10pFormaPagoCodigo = (String)getParm(obj,1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pFormaPagoCodigo", AV10pFormaPagoCodigo);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1584255");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00m0.js", "?1584255");
      ...
      protected void sendrow_312( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_31_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A41ClinicaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A65FormaPagoCodigo))+"'"+"]);" ;
            ClassString = "Image" ;
            StyleString = "" ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            edtFormaPagoNombre_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A41ClinicaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A65FormaPagoCodigo))+"'"+"]);" ;
      ...
      public override void initialize( )
      {
         ...
         lV7cFormaPagoCodigo = "" ;
         lV8cFormaPagoNombre = "" ;
         H000S2_A66FormaPagoNombre = new String[] {""} ;
         H000S2_A65FormaPagoCodigo = new String[] {""} ;
         H000S2_A41ClinicaCodigo = new String[] {""} ;
         H000S3_AGRID1_nRecordCount = new int[1] ;
         sStyleString = "" ;
         ClassString = "" ;
         StyleString = "" ;
         subGrid1_Linesclass = "" ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00m0__default(),
            new Object[][] {
                new Object[] {
               H000S2_A66FormaPagoNombre, H000S2_A65FormaPagoCodigo, H000S2_A41ClinicaCodigo
               }
               , new Object[] {
      ...
      private String AV7cFormaPagoCodigo ;
      private String AV8cFormaPagoNombre ;
      private String AV9pClinicaCodigo ;
      private String AV10pFormaPagoCodigo ;
      private String A41ClinicaCodigo ;
      private String A65FormaPagoCodigo ;
      private String A66FormaPagoNombre ;
      private String lV6cClinicaCodigo ;
      private String lV7cFormaPagoCodigo ;
      private String lV8cFormaPagoNombre ;
      ...
      private String[] H000S2_A66FormaPagoNombre ;
      private String[] H000S2_A65FormaPagoCodigo ;
      private String[] H000S2_A41ClinicaCodigo ;
      private int[] H000S3_AGRID1_nRecordCount ;
   ...
   public class gx00m0__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV7cFormaPagoCodigo",SqlDbType.VarChar,10,0} ,
          new Object[] {"@lV8cFormaPagoNombre",SqlDbType.VarChar,70,0}
          } ;
          Object[] prmH000S3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000S2", "SELECT [FormaPagoNombre], [FormaPagoCodigo], [ClinicaCodigo] FROM [FormaPago] WITH (NOLOCK) WHERE ([ClinicaCodigo] like @lV6cClinicaCodigo) AND ([FormaPagoCodigo] like @lV7cFormaPagoCodigo) AND ([FormaPagoNombre] like @lV8cFormaPagoNombre) ORDER BY [ClinicaCodigo], [FormaPagoCodigo]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S2,11,0,false,false )
             ,new CursorDef("H000S3", "SELECT COUNT(*) FROM [FormaPago] WITH (NOLOCK) WHERE ([ClinicaCodigo] like @lV6cClinicaCodigo) AND ([FormaPagoCodigo] like @lV7cFormaPagoCodigo) AND ([FormaPagoNombre] like @lV8cFormaPagoNombre) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S3,1,0,false,false )
          };
       }
    }
