/*
       ...
       Generated on: 10/2/2019 15:9:44.41
...
namespace GeneXus.Programs {
   public class gx01x0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx01x0( )
      {
      ...
      public gx01x0( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( Grid1_PageSize51, AV6cClinicaCodigo, AV7cCuentaBancariaCodigo, AV8cDepositoId, AV9cDepositoFecha, AV10cDepositoEfectivo, AV11cDepositoCheque, AV12cUsuarioCodigo) ;
               return  ;
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx01x0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV13pClinicaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV14pCuentaBancariaCodigo)) + "," + UrlEncode("" +AV15pDepositoId)+"\" class=\""+"Form"+"\">") ;
      ...
      {
         return formatLink("gx01x0.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV13pClinicaCodigo)) + "," + UrlEncode(StringUtil.RTrim(AV14pCuentaBancariaCodigo)) + "," + UrlEncode("" +AV15pDepositoId) ;
      }
      ...
      protected void WB330( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_2_332( true) ;
         }
         else
         {
            wb_table1_2_332( false) ;
         }
         return  ;
      }

      protected void wb_table1_2_332e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void RF332( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cUsuarioCodigo", AV12cUsuarioCodigo);
            /* Using cursor H00332 */
            pr_default.execute(0, new Object[] {lV6cClinicaCodigo, lV7cCuentaBancariaCodigo, AV8cDepositoId, AV9cDepositoFecha, AV10cDepositoEfectivo, AV11cDepositoCheque, lV12cUsuarioCodigo});
            nGXsfl_51_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A4UsuarioCodigo = H00332_A4UsuarioCodigo[0] ;
               A285DepositoCheque = H00332_A285DepositoCheque[0] ;
               A284DepositoEfectivo = H00332_A284DepositoEfectivo[0] ;
               A283DepositoFecha = H00332_A283DepositoFecha[0] ;
               A282DepositoId = H00332_A282DepositoId[0] ;
               A128CuentaBancariaCodigo = H00332_A128CuentaBancariaCodigo[0] ;
               A41ClinicaCodigo = H00332_A41ClinicaCodigo[0] ;
               /* Execute user event: E12332 */
               E12332 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cUsuarioCodigo", AV12cUsuarioCodigo);
         /* Using cursor H00333 */
         pr_default.execute(1, new Object[] {lV6cClinicaCodigo, lV7cCuentaBancariaCodigo, AV8cDepositoId, AV9cDepositoFecha, AV10cDepositoEfectivo, AV11cDepositoCheque, lV12cUsuarioCodigo});
      ...
      protected void E13332( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15pDepositoId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV15pDepositoId), 9, 0)));
         context.setWebReturnParms(new Object[] {(String)AV13pClinicaCodigo,(String)AV14pCuentaBancariaCodigo,(int)AV15pDepositoId});
         context.nUserReturn = 1 ;
         returnInSub = true;
         if (true) return;
      }

      protected void wb_table1_2_332( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_9_332( true) ;
         }
         else
         {
            wb_table2_9_332( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_332e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_48_332( true) ;
         }
         else
         {
            wb_table3_48_332( false) ;
         }
         return  ;
      }

      protected void wb_table3_48_332e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
            ...
            wb_table1_2_332e( true) ;
         }
         else
         {
            wb_table1_2_332e( false) ;
         }
      }

      protected void wb_table3_48_332( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 51 )
         {
            ...
            wb_table4_62_332( true) ;
         }
         else
         {
            wb_table4_62_332( false) ;
         }
         return  ;
      }

      protected void wb_table4_62_332e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_48_332e( true) ;
         }
         else
         {
            wb_table3_48_332e( false) ;
         }
      }

      protected void wb_table4_62_332( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(51), 3, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "ECANCEL.", TempTags, "", context.GetButtonType( ), "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_62_332e( true) ;
         }
         else
         {
            wb_table4_62_332e( false) ;
         }
      }

      protected void wb_table2_9_332( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockclinicacodigo_Internalname, "Código", "", "", lblTextblockclinicacodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cClinicaCodigo", AV6cClinicaCodigo);
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCclinicacodigo_Internalname, StringUtil.RTrim( AV6cClinicaCodigo), StringUtil.RTrim( context.localUtil.Format( AV6cClinicaCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(14);\"", "", "", "", "", edtavCclinicacodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockcuentabancariacodigo_Internalname, "Código", "", "", lblTextblockcuentabancariacodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cCuentaBancariaCodigo", AV7cCuentaBancariaCodigo);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCcuentabancariacodigo_Internalname, StringUtil.RTrim( AV7cCuentaBancariaCodigo), StringUtil.RTrim( context.localUtil.Format( AV7cCuentaBancariaCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(19);\"", "", "", "", "", edtavCcuentabancariacodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdepositoid_Internalname, "Depósito", "", "", lblTextblockdepositoid_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDepositoId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8cDepositoId), 9, 0)));
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCdepositoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cDepositoId), 9, 0, ".", "")), ((1!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8cDepositoId), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV8cDepositoId), "ZZZZZZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(24);\"", "", "", "", "", edtavCdepositoid_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, true, "right", "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdepositofecha_Internalname, "Fecha", "", "", lblTextblockdepositofecha_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cDepositoFecha", context.localUtil.Format(AV9cDepositoFecha, "99/99/99"));
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdepositoefectivo_Internalname, "Efectivo", "", "", lblTextblockdepositoefectivo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10cDepositoEfectivo", StringUtil.LTrim( StringUtil.Str( AV10cDepositoEfectivo, 17, 2)));
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdepositocheque_Internalname, "Cheques", "", "", lblTextblockdepositocheque_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cDepositoCheque", StringUtil.LTrim( StringUtil.Str( AV11cDepositoCheque, 17, 2)));
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockusuariocodigo_Internalname, "Usuario", "", "", lblTextblockusuariocodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cUsuarioCodigo", AV12cUsuarioCodigo);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCusuariocodigo_Internalname, StringUtil.RTrim( AV12cUsuarioCodigo), StringUtil.RTrim( context.localUtil.Format( AV12cUsuarioCodigo, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(44);\"", "", "", "", "", edtavCusuariocodigo_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, true, "left", "HLP_Gx01X0.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_332e( true) ;
         }
         else
         {
            wb_table2_9_332e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1594514");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx01x0.js", "?1594514");
      ...
      protected void sendrow_512( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_51_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A41ClinicaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A128CuentaBancariaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A282DepositoId), 9, 0, ".", "")))+"'"+"]);" ;
            ClassString = "Image" ;
            StyleString = "" ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            edtDepositoFecha_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A41ClinicaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A128CuentaBancariaCodigo))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A282DepositoId), 9, 0, ".", "")))+"'"+"]);" ;
      ...
      public override void initialize( )
      {
         ...
         lV12cUsuarioCodigo = "" ;
         H00332_A4UsuarioCodigo = new String[] {""} ;
         H00332_A285DepositoCheque = new decimal[1] ;
         H00332_A284DepositoEfectivo = new decimal[1] ;
         H00332_A283DepositoFecha = new DateTime[] {DateTime.MinValue} ;
         H00332_A282DepositoId = new int[1] ;
         H00332_A128CuentaBancariaCodigo = new String[] {""} ;
         H00332_A41ClinicaCodigo = new String[] {""} ;
         H00333_AGRID1_nRecordCount = new int[1] ;
         sStyleString = "" ;
         ClassString = "" ;
         StyleString = "" ;
         subGrid1_Linesclass = "" ;
         ...
         ROClassString = "" ;
         GXt_char9 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx01x0__default(),
            new Object[][] {
                new Object[] {
               H00332_A4UsuarioCodigo, H00332_A285DepositoCheque, H00332_A284DepositoEfectivo, H00332_A283DepositoFecha, H00332_A282DepositoId, H00332_A128CuentaBancariaCodigo, H00332_A41ClinicaCodigo
               }
               , new Object[] {
      ...
      private String[] H00332_A4UsuarioCodigo ;
      private decimal[] H00332_A285DepositoCheque ;
      private decimal[] H00332_A284DepositoEfectivo ;
      private DateTime[] H00332_A283DepositoFecha ;
      private int[] H00332_A282DepositoId ;
      private String[] H00332_A128CuentaBancariaCodigo ;
      private String[] H00332_A41ClinicaCodigo ;
      private int[] H00333_AGRID1_nRecordCount ;
   ...
   public class gx01x0__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00332", "SELECT [UsuarioCodigo], [DepositoCheque], [DepositoEfectivo], [DepositoFecha], [DepositoId], [CuentaBancariaCodigo], [ClinicaCodigo] FROM [DepositoBancario] WITH (NOLOCK) WHERE ([ClinicaCodigo] like @lV6cClinicaCodigo) AND ([CuentaBancariaCodigo] like @lV7cCuentaBancariaCodigo) AND ([DepositoId] >= @AV8cDepositoId) AND ([DepositoFecha] >= @AV9cDepositoFecha) AND ([DepositoEfectivo] >= @AV10cDepositoEfectivo) AND ([DepositoCheque] >= @AV11cDepositoCheque) AND ([UsuarioCodigo] like @lV12cUsuarioCodigo) ORDER BY [ClinicaCodigo], [CuentaBancariaCodigo], [DepositoId]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00332,11,0,false,false )
             ,new CursorDef("H00333", "SELECT COUNT(*) FROM [DepositoBancario] WITH (NOLOCK) WHERE ([ClinicaCodigo] like @lV6cClinicaCodigo) AND ([CuentaBancariaCodigo] like @lV7cCuentaBancariaCodigo) AND ([DepositoId] >= @AV8cDepositoId) AND ([DepositoFecha] >= @AV9cDepositoFecha) AND ([DepositoEfectivo] >= @AV10cDepositoEfectivo) AND ([DepositoCheque] >= @AV11cDepositoCheque) AND ([UsuarioCodigo] like @lV12cUsuarioCodigo) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00333,1,0,false,false )
          };
       }
    }
