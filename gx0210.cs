...
namespace GeneXus.Programs {
   public class gx0210 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Religiones", "", "", "", "", "", "", "", "") ;
      ...
      protected void wb_table2_9_3E2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockclinicacodigo_Internalname, "Código", "", "", lblTextblockclinicacodigo_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx0210.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cClinicaCodigo", AV6cClinicaCodigo);
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockreligionid_Internalname, "Religión", "", "", lblTextblockreligionid_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx0210.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cReligionId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7cReligionId), 9, 0)));
