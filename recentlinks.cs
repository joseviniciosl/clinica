/*
       ...
       Generated on: 10/2/2019 15:3:31.58
...
namespace GeneXus.Programs {
   public class recentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = UrlEncode(StringUtil.RTrim(AV6FormCaption)) + "," + UrlEncode(StringUtil.RTrim(AV7FormPgmName)) ;
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("recentlinks.aspx") + "?" + Crypto.Encrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\" class=\""+"Form"+"\">") ;
      ...
      protected void RenderHtmlCloseForm022( )
      {
         ...
         {
            context.AddJavascriptSource("recentlinks.js", "?1533161");
         }
      ...
      private void E11022( )
      {
         ...
         AV8Session.Set("RecentLinks", AV11RecentLinksItems.ToXml(false, "LinkList", "Clinica"));
         AV9i = 1 ;
         while ( AV9i <= AV11RecentLinksItems.Count )
         {
            AV12RecentLinksItem = ((SdtLinkList_LinkItem)AV11RecentLinksItems.Item(AV9i)) ;
      ...
      protected void wb_table1_2_022( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblRecenttext_Internalname, "Recents: ", "", "", lblRecenttext_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_RecentLinks.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /*  Grid Control  */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1533176");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("recentlinks.js", "?1533176");
         }
      ...
      protected void sendrow_72( )
      {
         ...
         ClassString = "RecentLink" ;
         StyleString = "" ;
         LinksRow.AddColumnProperties("label", 1, isAjaxCallMode( ), new Object[] {(String)lblPlace_Internalname,(String)lblPlace_Caption,(String)lblPlace_Link,(String)"",(String)lblPlace_Jsonclick,(String)"",(String)StyleString,(String)ClassString,(short)0,(String)"",(short)1,(short)1,(short)0});
         if ( LinksContainer.GetWrapped() == 1 )
         {
      ...
      public override void initialize( )
      {
         ...
         AV11RecentLinksItems = new GxObjectCollection( context, "LinkList.LinkItem", "Clinica", "SdtLinkList_LinkItem", "GeneXus.Programs");
