         ...
         if ( oReader.IsSimple == 0 )
         {
            ...
            while ( ( ( StringUtil.StrCmp(oReader.Name, sTagName) != 0 ) || ( oReader.NodeType == 1 ) ) && ( GXSoapError > 0 ) )
            {
               ...
               if ( StringUtil.StrCmp2( oReader.LocalName, "Attributes") )
               {
                  ...
                  {
                     gxTv_SdtTransactionContext_Attributes = new GxObjectCollection( context, "TransactionContext.Attribute", "Clinica", "SdtTransactionContext_Attribute", "GeneXus.Programs");
                  }
                  if ( oReader.IsSimple == 0 )
                  {
