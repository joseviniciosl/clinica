/*
               File: wp_paciente_emf
        Description: Consulta de Pacientes
             Author: GeneXus C# Generator version 10_1_8-58720
       Generated on: 10/2/2019 15:7:45.38
...
namespace GeneXus.Programs {
   public class wp_paciente_emf : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wp_paciente_emf( )
      {
      ...
      public wp_paciente_emf( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV10PacienteNombre1 = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10PacienteNombre1", AV10PacienteNombre1);
               AV11PacienteNombre2 = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11PacienteNombre2", AV11PacienteNombre2);
               AV6PacienteApellido1 = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6PacienteApellido1", AV6PacienteApellido1);
               AV7PacienteApellido2 = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7PacienteApellido2", AV7PacienteApellido2);
               AV8PacienteApellido3 = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8PacienteApellido3", AV8PacienteApellido3);
               ...
               gxgrGrid1_refresh( Grid1_PageSize36, AV10PacienteNombre1, AV11PacienteNombre2, AV6PacienteApellido1, AV7PacienteApellido2, AV8PacienteApellido3, AV5ClinicaCodigo) ;
               return  ;
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("wp_paciente_emf.aspx") +"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPACIENTENOMBRE1", StringUtil.RTrim( AV10PacienteNombre1));
         GxWebStd.gx_hidden_field( context, "GXH_vPACIENTENOMBRE2", StringUtil.RTrim( AV11PacienteNombre2));
         GxWebStd.gx_hidden_field( context, "GXH_vPACIENTEAPELLIDO1", StringUtil.RTrim( AV6PacienteApellido1));
         GxWebStd.gx_hidden_field( context, "GXH_vPACIENTEAPELLIDO2", StringUtil.RTrim( AV7PacienteApellido2));
         GxWebStd.gx_hidden_field( context, "GXH_vPACIENTEAPELLIDO3", StringUtil.RTrim( AV8PacienteApellido3));
         /* Send saved values. */
      ...
      {
         return formatLink("wp_paciente_emf.aspx")  ;
      }
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vPACIENTENOMBRE1"), AV10PacienteNombre1) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vPACIENTENOMBRE2"), AV11PacienteNombre2) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vPACIENTEAPELLIDO1"), AV6PacienteApellido1) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vPACIENTEAPELLIDO2"), AV7PacienteApellido2) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vPACIENTEAPELLIDO3"), AV8PacienteApellido3) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'EXPEDIENTES'") == 0 )
                           {
                              context.wbHandled = 1 ;
                              dynload_actions( ) ;
      ...
      protected void gxgrGrid1_refresh( int Grid1_PageSize36 ,
                                        String AV10PacienteNombre1 ,
                                        String AV11PacienteNombre2 ,
                                        String AV6PacienteApellido1 ,
                                        String AV7PacienteApellido2 ,
                                        String AV8PacienteApellido3 ,
      ...
      protected void RF1O2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            edtPacienteNacimiento_Internalname = "PACIENTENACIMIENTO_"+sGXsfl_36_idx ;
            cmbPacienteSexo_Internalname = "PACIENTESEXO_"+sGXsfl_36_idx ;
            lV10PacienteNombre1 = StringUtil.PadR( StringUtil.RTrim( AV10PacienteNombre1), 70, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10PacienteNombre1", AV10PacienteNombre1);
            lV11PacienteNombre2 = StringUtil.PadR( StringUtil.RTrim( AV11PacienteNombre2), 70, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11PacienteNombre2", AV11PacienteNombre2);
            lV6PacienteApellido1 = StringUtil.PadR( StringUtil.RTrim( AV6PacienteApellido1), 30, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6PacienteApellido1", AV6PacienteApellido1);
            lV7PacienteApellido2 = StringUtil.PadR( StringUtil.RTrim( AV7PacienteApellido2), 30, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7PacienteApellido2", AV7PacienteApellido2);
            lV8PacienteApellido3 = StringUtil.PadR( StringUtil.RTrim( AV8PacienteApellido3), 30, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8PacienteApellido3", AV8PacienteApellido3);
            /* Using cursor H001O2 */
            pr_default.execute(0, new Object[] {AV5ClinicaCodigo, lV10PacienteNombre1, AV10PacienteNombre1, lV11PacienteNombre2, AV11PacienteNombre2, lV6PacienteApellido1, AV6PacienteApellido1, lV7PacienteApellido2, AV7PacienteApellido2, lV8PacienteApellido3, AV8PacienteApellido3});
            nGXsfl_36_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 12 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A326PacienteSexo = H001O2_A326PacienteSexo[0] ;
               A74PacienteNacimiento = H001O2_A74PacienteNacimiento[0] ;
               A72PacienteApellido3 = H001O2_A72PacienteApellido3[0] ;
               A71PacienteApellido2 = H001O2_A71PacienteApellido2[0] ;
               A70PacienteApellido1 = H001O2_A70PacienteApellido1[0] ;
               A69PacienteNombre2 = H001O2_A69PacienteNombre2[0] ;
               A68PacienteNombre1 = H001O2_A68PacienteNombre1[0] ;
               A67PacienteId = H001O2_A67PacienteId[0] ;
               A41ClinicaCodigo = H001O2_A41ClinicaCodigo[0] ;
               /* Execute user event: E201O2 */
               E201O2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8PacienteApellido3", AV8PacienteApellido3);
         /* Using cursor H001O3 */
         pr_default.execute(1, new Object[] {AV5ClinicaCodigo, lV10PacienteNombre1, AV10PacienteNombre1, lV11PacienteNombre2, AV11PacienteNombre2, lV6PacienteApellido1, AV6PacienteApellido1, lV7PacienteApellido2, AV7PacienteApellido2, lV8PacienteApellido3, AV8PacienteApellido3});
      ...
      protected void STRUP1O0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11PacienteNombre2", AV11PacienteNombre2);
            AV6PacienteApellido1 = cgiGet( edtavPacienteapellido1_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6PacienteApellido1", AV6PacienteApellido1);
            AV7PacienteApellido2 = cgiGet( edtavPacienteapellido2_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7PacienteApellido2", AV7PacienteApellido2);
            AV8PacienteApellido3 = cgiGet( edtavPacienteapellido3_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8PacienteApellido3", AV8PacienteApellido3);
            /* Read saved values. */
      ...
      {
         /* Start Routine */
         GXt_SdtParametros4 = AV12Parametros ;
         new pobtienesesion(context ).execute( out  GXt_SdtParametros4) ;
         AV12Parametros = GXt_SdtParametros4 ;
         AV5ClinicaCodigo = AV12Parametros.gxTpr_Pclinicacodigo ;
      }
      ...
      protected void E161O2( )
      {
         ...
         GXt_int5 = AV9PacienteId ;
         new oobtienecorrelativo(context ).execute(  AV5ClinicaCodigo,  3, out  GXt_int5) ;
         AV9PacienteId = GXt_int5 ;
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
         {
            gxcookieaux = context.SetCookie( "GX_SESSION_ID", Crypto.Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", 0) ;
         }
         GXKey = Crypto.Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( )) ;
         GXEncryptionTmp = UrlEncode("" +AV9PacienteId) + "," + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +2) ;
      ...
      protected void E171O2( )
      {
         ...
         if ( A67PacienteId > 0 )
         {
            ...
            GXKey = Crypto.Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( )) ;
            GXEncryptionTmp = UrlEncode("" +A67PacienteId) + "," + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +2) ;
            context.wjLoc = formatLink("paciente.aspx") + "?" + Crypto.Encrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
         }
      }
      ...
      protected void E181O2( )
      {
         ...
         if ( A67PacienteId > 0 )
         {
            ...
            GXKey = Crypto.Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( )) ;
            GXEncryptionTmp = UrlEncode("" +A67PacienteId) ;
      ...
      protected void wb_table1_2_1O2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Pacientes", "", "", lblTextblock1_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_wp_paciente_emf.htm");
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td style=\"text-align:"+context.GetCssProperty( "Align", "center")+"\">") ;
            wb_table2_11_1O2( true) ;
         }
         else
         {
            wb_table2_11_1O2( false) ;
         }
         return  ;
      }

      protected void wb_table2_11_1O2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
         ...
         if ( wbEnd == 36 )
         {
            ...
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton1_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", "|<", bttButton1_Jsonclick, 5, "|<", "", StyleString, ClassString, 1, 1, "standard", "E\\'FIRST\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "&nbsp;") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 49,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton2_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", "<", bttButton2_Jsonclick, 5, "<", "", StyleString, ClassString, 1, 1, "standard", "E\\'PREVIOUS\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "&nbsp;") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 50,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton3_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", ">", bttButton3_Jsonclick, 5, ">", "", StyleString, ClassString, 1, 1, "standard", "E\\'NEXT\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "&nbsp;") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 51,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton4_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", ">|", bttButton4_Jsonclick, 5, ">|", "", StyleString, ClassString, 1, 1, "standard", "E\\'LAST\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton5_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", "Nuevo Paciente", bttButton5_Jsonclick, 5, "Nuevo Paciente", "", StyleString, ClassString, 1, 1, "standard", "E\\'NUEVO PACIENTE\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "&nbsp;") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 57,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton6_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", "Expedientes", bttButton6_Jsonclick, 5, "Expedientes", "", StyleString, ClassString, 1, 1, "standard", "E\\'EXPEDIENTES\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "&nbsp;") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 58,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton7_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", "Regresar", bttButton7_Jsonclick, 5, "Regresar", "", StyleString, ClassString, 1, 1, "standard", "E\\'REGRESAR\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void wb_table2_11_1O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "Primer Nombre", "", "", lblTextblock2_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            ClassString = "TextBlock" ;
            StyleString = "font-family:'Microsoft YaHei UI'; font-size:10.0pt; font-weight:bold; font-style:normal;" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "Segundo Nombre", "", "", lblTextblock3_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            ClassString = "TextBlock" ;
            StyleString = "font-family:'Microsoft YaHei UI'; font-size:10.0pt; font-weight:bold; font-style:normal;" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, "Primer Apellido", "", "", lblTextblock4_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            ClassString = "TextBlock" ;
            StyleString = "font-family:'Microsoft YaHei UI'; font-size:10.0pt; font-weight:bold; font-style:normal;" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock5_Internalname, "Segundo Apellido", "", "", lblTextblock5_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            ClassString = "TextBlock" ;
            StyleString = "font-family:'Microsoft YaHei UI'; font-size:10.0pt; font-weight:bold; font-style:normal;" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock6_Internalname, "Apellido de Casada", "", "", lblTextblock6_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavPacientenombre1_Internalname, StringUtil.RTrim( AV10PacienteNombre1), StringUtil.RTrim( context.localUtil.Format( AV10PacienteNombre1, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(25);\"", "", "", "", "", edtavPacientenombre1_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 70, "chr", 1, "row", 70, 0, 0, 0, 1, -1, true, "left", "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11PacienteNombre2", AV11PacienteNombre2);
            ...
            ClassString = "Attribute" ;
            StyleString = "font-family:'Microsoft YaHei UI'; font-size:10.0pt; font-weight:normal; font-style:normal;" ;
            GxWebStd.gx_single_line_edit( context, edtavPacientenombre2_Internalname, StringUtil.RTrim( AV11PacienteNombre2), StringUtil.RTrim( context.localUtil.Format( AV11PacienteNombre2, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(27);\"", "", "", "", "", edtavPacientenombre2_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 70, "chr", 1, "row", 70, 0, 0, 0, 1, -1, true, "left", "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6PacienteApellido1", AV6PacienteApellido1);
            ...
            ClassString = "Attribute" ;
            StyleString = "font-family:'Microsoft YaHei UI'; font-size:10.0pt; font-weight:normal; font-style:normal;" ;
            GxWebStd.gx_single_line_edit( context, edtavPacienteapellido1_Internalname, StringUtil.RTrim( AV6PacienteApellido1), StringUtil.RTrim( context.localUtil.Format( AV6PacienteApellido1, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(29);\"", "", "", "", "", edtavPacienteapellido1_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, true, "left", "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7PacienteApellido2", AV7PacienteApellido2);
            ...
            ClassString = "Attribute" ;
            StyleString = "font-family:'Microsoft YaHei UI'; font-size:10.0pt; font-weight:normal; font-style:normal;" ;
            GxWebStd.gx_single_line_edit( context, edtavPacienteapellido2_Internalname, StringUtil.RTrim( AV7PacienteApellido2), StringUtil.RTrim( context.localUtil.Format( AV7PacienteApellido2, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(31);\"", "", "", "", "", edtavPacienteapellido2_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, true, "left", "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8PacienteApellido3", AV8PacienteApellido3);
            ...
            ClassString = "Attribute" ;
            StyleString = "font-family:'Microsoft YaHei UI'; font-size:10.0pt; font-weight:normal; font-style:normal;" ;
            GxWebStd.gx_single_line_edit( context, edtavPacienteapellido3_Internalname, StringUtil.RTrim( AV8PacienteApellido3), StringUtil.RTrim( context.localUtil.Format( AV8PacienteApellido3, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(33);\"", "", "", "", "", edtavPacienteapellido3_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, true, "left", "HLP_wp_paciente_emf.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_11_1O2e( true) ;
         }
         else
         {
            wb_table2_11_1O2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?1574612");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_paciente_emf.js", "?1574613");
      ...
      public override void initialize( )
      {
         ...
         lV10PacienteNombre1 = "" ;
         lV11PacienteNombre2 = "" ;
         lV6PacienteApellido1 = "" ;
         lV7PacienteApellido2 = "" ;
         lV8PacienteApellido3 = "" ;
         H001O2_A326PacienteSexo = new String[] {""} ;
         H001O2_A74PacienteNacimiento = new DateTime[] {DateTime.MinValue} ;
         H001O2_A72PacienteApellido3 = new String[] {""} ;
         H001O2_A71PacienteApellido2 = new String[] {""} ;
         H001O2_A70PacienteApellido1 = new String[] {""} ;
         H001O2_A69PacienteNombre2 = new String[] {""} ;
         H001O2_A68PacienteNombre1 = new String[] {""} ;
         H001O2_A67PacienteId = new int[1] ;
         H001O2_A41ClinicaCodigo = new String[] {""} ;
         H001O3_AGRID1_nRecordCount = new int[1] ;
         ...
         ROClassString = "" ;
         GXt_char12 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_paciente_emf__default(),
            new Object[][] {
                new Object[] {
               H001O2_A326PacienteSexo, H001O2_A74PacienteNacimiento, H001O2_A72PacienteApellido3, H001O2_A71PacienteApellido2, H001O2_A70PacienteApellido1, H001O2_A69PacienteNombre2, H001O2_A68PacienteNombre1, H001O2_A67PacienteId, H001O2_A41ClinicaCodigo
               }
               , new Object[] {
      ...
      private String lV10PacienteNombre1 ;
      private String lV11PacienteNombre2 ;
      private String lV6PacienteApellido1 ;
      private String lV7PacienteApellido2 ;
      private String lV8PacienteApellido3 ;
      ...
      private String[] H001O2_A326PacienteSexo ;
      private DateTime[] H001O2_A74PacienteNacimiento ;
      private String[] H001O2_A72PacienteApellido3 ;
      private String[] H001O2_A71PacienteApellido2 ;
      private String[] H001O2_A70PacienteApellido1 ;
      private String[] H001O2_A69PacienteNombre2 ;
      private String[] H001O2_A68PacienteNombre1 ;
      private int[] H001O2_A67PacienteId ;
      private String[] H001O2_A41ClinicaCodigo ;
      private int[] H001O3_AGRID1_nRecordCount ;
   ...
   public class wp_paciente_emf__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV10PacienteNombre1",SqlDbType.VarChar,70,0} ,
          new Object[] {"@AV10PacienteNombre1",SqlDbType.VarChar,70,0} ,
          new Object[] {"@lV11PacienteNombre2",SqlDbType.VarChar,70,0} ,
          new Object[] {"@AV11PacienteNombre2",SqlDbType.VarChar,70,0} ,
          new Object[] {"@lV6PacienteApellido1",SqlDbType.VarChar,30,0} ,
          new Object[] {"@AV6PacienteApellido1",SqlDbType.VarChar,30,0} ,
          new Object[] {"@lV7PacienteApellido2",SqlDbType.VarChar,30,0} ,
          new Object[] {"@AV7PacienteApellido2",SqlDbType.VarChar,30,0} ,
          new Object[] {"@lV8PacienteApellido3",SqlDbType.VarChar,30,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001O2", "SELECT [PacienteSexo], [PacienteNacimiento], [PacienteApellido3], [PacienteApellido2], [PacienteApellido1], [PacienteNombre2], [PacienteNombre1], [PacienteId], [ClinicaCodigo] FROM [Paciente] WITH (NOLOCK) WHERE ([ClinicaCodigo] = @AV5ClinicaCodigo) AND ([PacienteNombre1] like @lV10PacienteNombre1 or (@AV10PacienteNombre1 = '')) AND ([PacienteNombre2] like @lV11PacienteNombre2 or (@AV11PacienteNombre2 = '')) AND ([PacienteApellido1] like @lV6PacienteApellido1 or (@AV6PacienteApellido1 = '')) AND ([PacienteApellido2] like @lV7PacienteApellido2 or (@AV7PacienteApellido2 = '')) AND ([PacienteApellido3] like @lV8PacienteApellido3 or (@AV8PacienteApellido3 = '')) ORDER BY [ClinicaCodigo], [PacienteId]  OPTION (FAST 13)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001O2,13,0,true,false )
             ,new CursorDef("H001O3", "SELECT COUNT(*) FROM [Paciente] WITH (NOLOCK) WHERE ([ClinicaCodigo] = @AV5ClinicaCodigo) AND ([PacienteNombre1] like @lV10PacienteNombre1 or (@AV10PacienteNombre1 = '')) AND ([PacienteNombre2] like @lV11PacienteNombre2 or (@AV11PacienteNombre2 = '')) AND ([PacienteApellido1] like @lV6PacienteApellido1 or (@AV6PacienteApellido1 = '')) AND ([PacienteApellido2] like @lV7PacienteApellido2 or (@AV7PacienteApellido2 = '')) AND ([PacienteApellido3] like @lV8PacienteApellido3 or (@AV8PacienteApellido3 = '')) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001O3,1,0,true,false )
          };
       }
    }
