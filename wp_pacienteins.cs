/*
               File: wp_pacienteins
        Description: Alta de Pacientes
             Author: GeneXus C# Generator version 10_1_1-28290
       Generated on: 3/4/2019 15:41:50.4
...
namespace GeneXus.Programs {
   public class wp_pacienteins : GXDataArea
   {
      public wp_pacienteins( )
      {
      ...
      public wp_pacienteins( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.WriteHtmlText( " "+"bottommargin=\"0\""+" "+"rightmargin=\"0\""+" "+"leftmargin=\"0\""+" "+"marginwidth=\"0\""+" "+"class=\"Form\""+" "+"topmargin=\"0\""+" "+"marginheight=\"0\""+" "+" style=\"-moz-opacity: 0;opacity: 0;\" "+" bgcolor=\""+context.BuildHTMLColor( Form.Backcolor)+"\""+FormProcess+">") ;
         context.skipLines(1);
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"POST\" action=\""+formatLink("wp_pacienteins.aspx") +"\" class=\""+"Form"+"\">") ;
      ...
      {
         return formatLink("wp_pacienteins.aspx")  ;
      }
      ...
      protected void wb_table1_2_1I2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void START1I2( )
      {
         ...
         Form.Meta.addItem("Description", "Alta de Pacientes", 0) ;
         context.wjLoc = "" ;
      ...
      protected void wb_table1_2_1I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?15415010");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wp_pacienteins.js", "?15415010");
         }
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Alta de Pacientes" ;
      }
