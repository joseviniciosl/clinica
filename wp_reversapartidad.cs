/*
               File: wp_reversapartidad
        Description: Reversión de Partidas Contables
             Author: GeneXus C# Generator version 10_1_8-58720
       Generated on: 7/31/2019 16:27:35.89
...
namespace GeneXus.Programs {
   public class wp_reversapartidad : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wp_reversapartidad( )
      {
      ...
      public wp_reversapartidad( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("wp_reversapartidad.aspx") +"\" class=\""+"Form"+"\">") ;
      ...
      {
         return "wp_reversapartidad" ;
      }

      public override String GetPgmdesc( )
      {
         return "Reversión de Partidas Contables" ;
      }
      ...
      {
         return formatLink("wp_reversapartidad.aspx")  ;
      }
      ...
      protected void START372( )
      {
         ...
         Form.Meta.addItem("Description", "Reversión de Partidas Contables", 0) ;
         context.wjLoc = "" ;
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'ANULAR PARTIDA'") == 0 )
                           {
                              context.wbHandled = 1 ;
                              dynload_actions( ) ;
      ...
      protected void RF372( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A289PartidaEstado = H00372_A289PartidaEstado[0] ;
               A211PartidaMayorizada = H00372_A211PartidaMayorizada[0] ;
               A208PartidaFecha = H00372_A208PartidaFecha[0] ;
               A207PartidaId = H00372_A207PartidaId[0] ;
               A200TipoParNombre = H00372_A200TipoParNombre[0] ;
               A199TipoParCodigo = H00372_A199TipoParCodigo[0] ;
               A41ClinicaCodigo = H00372_A41ClinicaCodigo[0] ;
               A200TipoParNombre = H00372_A200TipoParNombre[0] ;
               /* Execute user event: E18372 */
               E18372 ();
      ...
      protected void E17372( )
      {
         ...
         AV10UsuarioCodigo = AV6Parametros.gxTpr_Pusuariocodigo ;
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8PartidaFechaA", context.localUtil.Format(AV8PartidaFechaA, "99/99/99"));
         bttButton5_Jsonclick = "confirm('¿Seguro de reversar la partida contable?')" ;
      ...
      {
         /* 'Anular partida' Routine */
         if ( ( A289PartidaEstado == 1 ) && ( A211PartidaMayorizada == 1 ) )
         {
            new preversapartida(context ).execute( ref  A41ClinicaCodigo, ref  A199TipoParCodigo, ref  A207PartidaId, ref  AV10UsuarioCodigo) ;
         }
         else
         {
            GX_msglist.addItem("Partida contable no puede revertirse. Revise");
         }
      }
      ...
      protected void wb_table1_2_372( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Partidas Contables", "", "", lblTextblock1_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_wp_reversapartidad.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            wb_table2_11_372( true) ;
         }
         else
         {
            wb_table2_11_372( false) ;
         }
         return  ;
      }

      protected void wb_table2_11_372e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
         ...
         if ( wbEnd == 24 )
         {
            ...
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton1_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 3, 0)+","+"null"+");", "|<", bttButton1_Jsonclick, 5, "|<", "", StyleString, ClassString, 1, 1, "standard", "E\\'FIRST\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_reversapartidad.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 35,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton2_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 3, 0)+","+"null"+");", "<", bttButton2_Jsonclick, 5, "<", "", StyleString, ClassString, 1, 1, "standard", "E\\'PREVIOUS\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_reversapartidad.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 36,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton3_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 3, 0)+","+"null"+");", ">", bttButton3_Jsonclick, 5, ">", "", StyleString, ClassString, 1, 1, "standard", "E\\'NEXT\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_reversapartidad.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 37,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton4_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 3, 0)+","+"null"+");", ">|", bttButton4_Jsonclick, 5, ">|", "", StyleString, ClassString, 1, 1, "standard", "E\\'LAST\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_reversapartidad.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton5_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 3, 0)+","+"null"+");", "Anular partida", bttButton5_Jsonclick, 5, "Anular partida", "", StyleString, ClassString, 1, 1, "standard", "E\\'ANULAR PARTIDA\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_reversapartidad.htm");
            context.WriteHtmlText( "&nbsp;") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 43,'',false,'',0)\"" ;
            ClassString = "Button" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttButton6_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 3, 0)+","+"null"+");", "Regresar", bttButton6_Jsonclick, 5, "Regresar", "", StyleString, ClassString, 1, 1, "standard", "E\\'REGRESAR\\'.", TempTags, "", context.GetButtonType( ), "HLP_wp_reversapartidad.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void wb_table2_11_372( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, "Fecha Del", "", "", lblTextblock4_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_wp_reversapartidad.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            ClassString = "TextBlock" ;
            StyleString = "font-family:'Microsoft YaHei UI'; font-size:10.0pt; font-weight:bold; font-style:normal;" ;
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "Fecha Al", "", "", lblTextblock3_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_wp_reversapartidad.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            GxWebStd.gx_bitmap( context, edtavPartidafechaa_Internalname+"_dp_trigger", "calendar-img.gif", "", "", "", "", ((1==0)||(1==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;vertical-align:text-bottom", "", "", "", "", "", "HLP_wp_reversapartidad.htm");
            context.WriteHtmlTextNl( "</div>") ;
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_11_372e( true) ;
         }
         else
         {
            wb_table2_11_372e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?16273652");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_reversapartidad.js", "?16273653");
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Reversión de Partidas Contables" ;
      ...
      public override void initialize( )
      {
         ...
         Grid1Container = new GXWebGrid( context);
         scmdbuf = "" ;
         H00372_A289PartidaEstado = new short[1] ;
         H00372_A211PartidaMayorizada = new short[1] ;
         H00372_A208PartidaFecha = new DateTime[] {DateTime.MinValue} ;
         H00372_A207PartidaId = new int[1] ;
         H00372_A200TipoParNombre = new String[] {""} ;
         H00372_A199TipoParCodigo = new String[] {""} ;
         H00372_A41ClinicaCodigo = new String[] {""} ;
         H00373_AGRID1_nRecordCount = new int[1] ;
         ...
         ROClassString = "" ;
         GXt_char9 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_reversapartidad__default(),
            new Object[][] {
                new Object[] {
               H00372_A289PartidaEstado, H00372_A211PartidaMayorizada, H00372_A208PartidaFecha, H00372_A207PartidaId, H00372_A200TipoParNombre, H00372_A199TipoParCodigo, H00372_A41ClinicaCodigo
               }
               , new Object[] {
      ...
      private short[] H00372_A289PartidaEstado ;
      private short[] H00372_A211PartidaMayorizada ;
      private DateTime[] H00372_A208PartidaFecha ;
      private int[] H00372_A207PartidaId ;
      private String[] H00372_A200TipoParNombre ;
      private String[] H00372_A199TipoParCodigo ;
      private String[] H00372_A41ClinicaCodigo ;
      private int[] H00373_AGRID1_nRecordCount ;
   ...
   public class wp_reversapartidad__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00372", "SELECT T1.[PartidaEstado], T1.[PartidaMayorizada], T1.[PartidaFecha], T1.[PartidaId], T2.[TipoParNombre], T1.[TipoParCodigo], T1.[ClinicaCodigo] FROM ([PartidaEnc] T1 WITH (NOLOCK) INNER JOIN [TipoPartida] T2 WITH (NOLOCK) ON T2.[ClinicaCodigo] = T1.[ClinicaCodigo] AND T2.[TipoParCodigo] = T1.[TipoParCodigo]) WHERE (T1.[ClinicaCodigo] = @AV5ClinicaCodigo) AND (T1.[PartidaFecha] >= @AV7PartidaFechaD) AND (T1.[PartidaFecha] <= @AV8PartidaFechaA) AND (T1.[PartidaEstado] = 1) AND (T1.[PartidaMayorizada] = 1) ORDER BY T1.[ClinicaCodigo], T1.[TipoParCodigo], T1.[PartidaId]  OPTION (FAST 13)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00372,13,0,true,false )
             ,new CursorDef("H00373", "SELECT COUNT(*) FROM ([PartidaEnc] T1 WITH (NOLOCK) INNER JOIN [TipoPartida] T2 WITH (NOLOCK) ON T2.[ClinicaCodigo] = T1.[ClinicaCodigo] AND T2.[TipoParCodigo] = T1.[TipoParCodigo]) WHERE (T1.[ClinicaCodigo] = @AV5ClinicaCodigo) AND (T1.[PartidaFecha] >= @AV7PartidaFechaD) AND (T1.[PartidaFecha] <= @AV8PartidaFechaA) AND (T1.[PartidaEstado] = 1) AND (T1.[PartidaMayorizada] = 1) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00373,1,0,true,false )
          };
       }
    }
